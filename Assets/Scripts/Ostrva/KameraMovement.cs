...
public class KameraMovement : MonoBehaviour
{
    ...
    public static int
        makniPopup =
            0; // 1 - misija, 2 - unlock bonus, 3 - bonus reward, 4 - watch video, 5 - shop, 6 - Tutorial delovi, 7 - Reward
    ...
    void Awake()
    {
        if (Advertisement.isSupported && StagesParser.Instance)
        {
        ...
        if (StagesParser.otvaraoShopNekad == 2 &&
            StagesParser.trenutniNivoNaOstrvu[StagesParser.currSetIndex] == 3) //StagesParser.currentLevel == 3)
        {
        ...
        Camera.main.transform.position = new Vector3(
            Mathf.Clamp(
                GameObject.Find("Level" + (StagesParser.trenutniNivoNaOstrvu[StagesParser.currSetIndex]).ToString())
                    .transform.position.x, levaGranica, desnaGranica),
            Mathf.Clamp(
                GameObject.Find("Level" + (StagesParser.trenutniNivoNaOstrvu[StagesParser.currSetIndex]).ToString())
                    .transform.position.y, donjaGranica, gornjaGranica), Camera.main.transform.position.z);

        if (StagesParser.pozicijaMajmuncetaNaMapi == Vector3.zero) //normalan nivo
        {
            if ( /*StagesParser.trenutniNivoNaOstrvu[StagesParser.currSetIndex] > 1 && */
                StagesParser.SetsInGame[StagesParser.currSetIndex].CurrentStarsInStageNEW > 0)
            {
                holderMajmun.position = izmedjneTacke
                    .Find(StagesParser.trenutniNivoNaOstrvu[StagesParser.currSetIndex].ToString()).position;
                monkeyCurrentLevelIndex =
                    GetMapLevelIndex(StagesParser.trenutniNivoNaOstrvu[StagesParser.currSetIndex]);
            }
        }
        else //bonus nivo
        {
            ...
            Camera.main.transform.position =
                new Vector3(Mathf.Clamp(holderMajmun.position.x, levaGranica, desnaGranica),
                    Mathf.Clamp(holderMajmun.position.y, donjaGranica, gornjaGranica),
            ...
            if (!StagesParser.dodatnaProveraIzasaoIzBonusa)
            {
                ...
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/PomocniColliderKodOtvaranjaKovcega").localScale =
                    new Vector3(200, 130, 1);
                PodesiReward();
            }
            else
            {
    ...
    void PodesiReward()
    {
        if (StagesParser.bonusID == 4) //cetvrti kovceg na mapi
        {
            ...
            reward2Type = 0;
            reward3Type = 0;
            _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward2").gameObject
                .SetActive(false);
            _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward3").gameObject
                .SetActive(false);
            IspitajItem();
        }
        else
        {
            if (StagesParser.currSetIndex == 0) //za 1. svet daj mu jednu nagradu na prva 3 kovcega
            {
                ...
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1/Count")
                    .GetComponent<TextMesh>().text = kolicinaReward1.ToString();
                ...
                if (StagesParser.powerup_magnets <= StagesParser.powerup_doublecoins)
                {
                    ...
                    {
                        reward1Type = 1;
                        _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                            .GetComponent<SpriteRenderer>().sprite = _GUI
                            .Find(
                                "ShopHolder/Shop/4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Magnet/Plavi Bedz/Magnet Icon")
                    ...
                    else
                    {
                        ...
                        _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                            .GetComponent<SpriteRenderer>().sprite = _GUI
                            .Find(
                                "ShopHolder/Shop/4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Shield/Plavi Bedz/Shield Icon")
                            .GetComponent<SpriteRenderer>().sprite;
                    }
                }
                else if (StagesParser.powerup_doublecoins <= StagesParser.powerup_shields)
                {
                    ...
                    _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                        .GetComponent<SpriteRenderer>().sprite = _GUI
                        .Find(
                            "ShopHolder/Shop/4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Double Coins/Plavi Bedz/Double Coins Icon")
                        .GetComponent<SpriteRenderer>().sprite;
                }
                else
                {
                    ...
                    _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                        .GetComponent<SpriteRenderer>().sprite = _GUI
                        .Find("ShopHolder/Shop/4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Shield/Plavi Bedz/Shield Icon")
                        .GetComponent<SpriteRenderer>().sprite;
                }
            }
            else if (StagesParser.currSetIndex < 3) //za 2. i 3. svet daj mu dve nagrade na prva 3 kovcega
            {
                ...
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1/Count")
                    .GetComponent<TextMesh>().text = kolicinaReward1.ToString();
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward2/Count")
                    .GetComponent<TextMesh>().text = kolicinaReward2.ToString();

                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                    .localPosition = new Vector3(-0.75f, 0.55f, -0.5f);
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward2")
                    .localPosition = new Vector3(0.75f, 0.55f, -0.5f);
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward3").gameObject
                    .SetActive(false);
                ...
                else if (StagesParser.powerup_magnets <= StagesParser.powerup_shields)
                {
                    ...
                    _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward2")
                        .GetComponent<SpriteRenderer>().sprite = _GUI
                        .Find("ShopHolder/Shop/4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Magnet/Plavi Bedz/Magnet Icon")
                        .GetComponent<SpriteRenderer>().sprite;
                }
                else
                {
            ...
            else //za 4. svet pa navise daj mu 3 nagrade na prva 3 kovcega
            {
                ...
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward2/Count")
                    .GetComponent<TextMesh>().text = kolicinaReward2.ToString();
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward3/Count")
                    .GetComponent<TextMesh>().text = kolicinaReward3.ToString();
                ...
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward2")
                    ...
                    .Find("ShopHolder/Shop/4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Shield/Plavi Bedz/Shield Icon")
                    .GetComponent<SpriteRenderer>().sprite;
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward3")
                    .GetComponent<SpriteRenderer>().sprite = _GUI
                    .Find(
                        "ShopHolder/Shop/4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Double Coins/Plavi Bedz/Double Coins Icon")
                    .GetComponent<SpriteRenderer>().sprite;
    ...
    void RefreshScene()
    {
        ...
        for (int i = 0; i < StagesParser.totalSets; i++)
        {
            ...
            if (StagesParser.currentStarsNEW >=
                StagesParser.SetsInGame[i].StarRequirement) //uslov za zvezdice je ok za i-to ostrvo
            {
                if (i > 0)
                {
        ...
        if (StagesParser.lastUnlockedWorldIndex <
            (Application.loadedLevel -
             4)) //@@@@@@@ DODATAK DA PROVERI DA SLUCAJNO LOGOVAN KORISNIK IMA MANJE OTKLJUCANIH OSTRVA NEGO NELOGOVAN KORISNIK - II deo
        {
        ...
        else
        {
            ...
            _GUI.Find("INTERFACE HOLDER/_TopLeft/Coins/Coins Number").GetComponent<TextMesh>().text =
                StagesParser.currentMoney.ToString();
            _GUI.Find("INTERFACE HOLDER/_TopLeft/Coins/Coins Number").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true);
            _GUI.Find("INTERFACE HOLDER/_TopLeft/PTS/PTS Number").GetComponent<TextMesh>().text =
                StagesParser.currentPoints.ToString();
            _GUI.Find("INTERFACE HOLDER/_TopLeft/PTS/PTS Number").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true);
            _GUI.Find("INTERFACE HOLDER/_TopLeft/BananaHolder/Bananas/Banana Number").GetComponent<TextMesh>().text =
                StagesParser.currentBananas.ToString();
            _GUI.Find("INTERFACE HOLDER/_TopLeft/BananaHolder/Bananas/Banana Number").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true);
            _GUI.Find("INTERFACE HOLDER/FB Login/Text/Number").GetComponent<TextMesh>().text =
                "+" + StagesParser.LoginReward.ToString();
            _GUI.Find("INTERFACE HOLDER/FB Login/Text/Number").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true);
            _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/WatchVideoReward")
                .GetComponent<TextMesh>().text = "+" + televizorCenePoSvetovima[StagesParser.currSetIndex].ToString();
            _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/WatchVideoReward")
                .GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
            if (reward1Type > 0)
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1/Count")
                    .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
            if (reward2Type > 0)
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward2/Count")
                    .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
            if (reward3Type > 0)
                _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward3/Count")
                    .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
            _GUI.Find("INTERFACE HOLDER/TotalStars/Stars Number").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true);
            changeLanguage();
    ...
    void Start()
    {
        ...
        if (Loading.Instance != null)
            ...
            _GUI.Find("LOADING HOLDER NEW/Loading Animation Vrata").GetComponent<Animator>()
                .Play("Loading Zidovi Odlazak");
        ...
        _GUI.Find("INTERFACE HOLDER/_TopLeft").position = new Vector3(guiCamera.ViewportToWorldPoint(Vector3.zero).x,
            _GUI.Find("INTERFACE HOLDER/_TopLeft").position.y, _GUI.Find("INTERFACE HOLDER/_TopLeft").position.z);
        _GUI.Find("INTERFACE HOLDER/FB Login").position = new Vector3(
            guiCamera.ViewportToWorldPoint(new Vector3(0.91f, 0, 0)).x,
            _GUI.Find("INTERFACE HOLDER/FB Login").position.y, _GUI.Find("INTERFACE HOLDER/FB Login").position.z);
        _GUI.Find("INTERFACE HOLDER/TotalStars").position = new Vector3(
            guiCamera.ViewportToWorldPoint(new Vector3(0.89f, 0, 0)).x,
            _GUI.Find("INTERFACE HOLDER/TotalStars").position.y, _GUI.Find("INTERFACE HOLDER/TotalStars").position.z);
        _GUI.Find("INTERFACE HOLDER/TotalStars/Stars Number").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(false, true);
        ...
        ShopManagerFull.ShopObject.transform
            .Find("1 Free Coins/Free Coins Tabovi/ShopFCWatchVideo/Polje za unos COINA U shopu - Shop/Coins Number")
            .GetComponent<TextMesh>().text = StagesParser.watchVideoReward.ToString();
        ...
        ShopManagerFull.ShopObject.transform
            .Find("1 Free Coins/Free Coins Tabovi/ShopFCWatchVideo/Polje za unos COINA U shopu - Shop/Coins Number")
            .GetComponent<TextMeshEffects>().RefreshTextOutline(false, false);
    ...
    void InitLevels(bool refreshed)
    {
        ...
        {
            GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + StagesParser.zadnjiOtkljucanNivo +
                            "/Level" + StagesParser.zadnjiOtkljucanNivo + "Move").GetComponent<Animator>()
                .Play("KatanacExplosion");
...
//			}
            ...
            {
                //locked
                GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" + (i + 1) +
                                "Move").GetComponent<SpriteRenderer>().sprite = GameObject.Find("RefCardClose")
                    .GetComponent<SpriteRenderer>().sprite;
                GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" + (i + 1) +
                                "Move").transform.Find("TextNumberLevel").GetComponent<TextMesh>().text =
                    System.String.Empty;
                GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" + (i + 1) +
                                "Move").transform.Find("TextNumberLevel").GetChild(0).GetComponent<TextMesh>().text =
                    System.String.Empty;
                GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" + (i + 1) +
                                "Move").transform.Find("Katanac").GetComponent<Renderer>().enabled = true;
                if (!GameObject
                        .Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" + (i + 1) +
                              "Move").transform.Find("Katanac").gameObject.activeSelf)
                {
                    GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" +
                                    (i + 1) + "Move").GetComponent<Animator>().enabled = false;
                    GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" +
                                    (i + 1) + "Move").transform.Find("Katanac").gameObject.SetActive(true);
                }
            }
            else
            {
                ...
                if ((i + 1) != StagesParser.zadnjiOtkljucanNivo ||
                    StagesParser.pozicijaMajmuncetaNaMapi != Vector3.zero)
                {
                    GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" +
                                    (i + 1) + "Move").GetComponent<SpriteRenderer>().sprite = GameObject
                        .Find("RefCardStar" + currentLevelStars).GetComponent<SpriteRenderer>().sprite;
                    GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" +
                                    (i + 1) + "Move").transform.Find("TextNumberLevel").GetComponent<TextMesh>().text =
                        (i + 1).ToString();
                    GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" +
                                    (i + 1) + "Move").transform.Find("Katanac").GetComponent<Renderer>().enabled =
                        false;
                    if (currentLevelStars == 0)
                        GameObject.Find("LevelsWorld" + StagesParser.currSetIndex + "/Level" + (i + 1) + "/Level" +
                                        (i + 1) + "Move").GetComponent<Animator>().Play("NewLevelLoop");
                }
        ...
        _GUI.Find("INTERFACE HOLDER/TotalStars/Stars Number").GetComponent<TextMesh>().text =
            StagesParser.SetsInGame[StagesParser.currSetIndex].CurrentStarsInStageNEW + "/" +
            StagesParser.SetsInGame[StagesParser.currSetIndex].StagesOnSet * 3;
    ...
    void Update()
    {
        if (Input.GetKeyUp(KeyCode.Escape))
        {
            ...
            else if (makniPopup == 5)
            {
                ...
                _GUI.Find("INTERFACE HOLDER/_TopLeft/Coins/Coins Number").GetComponent<TextMeshEffects>()
                    .RefreshTextOutline(false, true);
                _GUI.Find("INTERFACE HOLDER/_TopLeft/BananaHolder/Bananas/Banana Number").GetComponent<TextMesh>()
                    .text = StagesParser.currentBananas.ToString();
                _GUI.Find("INTERFACE HOLDER/_TopLeft/BananaHolder/Bananas/Banana Number")
                    .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
        ...
        if (Input.touchCount == 2 && Input.GetTouch(0).phase == TouchPhase.Moved &&
            Input.GetTouch(1).phase == TouchPhase.Moved && makniPopup == 0)
            //if(Input.GetKey(KeyCode.Z) || Input.GetKey(KeyCode.X))
        {
            ...
            if ((touchDelta - varianceInDistances <= -10) &&
                ((speedTouch0 > minPinchSpeed) || (speedTouch1 > minPinchSpeed)))
                ...
                //if(Input.GetKey(KeyCode.X))
            {
                Camera.main.orthographicSize =
                    Mathf.MoveTowards(Camera.main.orthographicSize, 4,
                        -actualDistance / 2); //za touch ovde je -actualDistance/2xzx
            }
            ...
            //if(Input.GetKeyUp(KeyCode.Z) || Input.GetKeyUp(KeyCode.X) && zoom)
        {
            ...
            if (doleDesno.position.x <
                ivicaEkrana.x) // && doleLevo.position.y > ivicaEkrana.y && !pomeriKameruUGranice)
            {
                pomeriKameruUGranice = true;
        ...
        if (!zoom)
        {
            if (Input.GetMouseButtonDown(0))
            {
                ...
                {
                    ShopManagerFull.ShopObject.transform.Find("3 Customize/Costumization BG/ClearAll/ClearAll_Selected")
            ...
            if (Input.GetMouseButton(0) && makniPopup == 0)
            {
                ...
                Camera.main.transform.position = new Vector3(
                    Mathf.Clamp(Camera.main.transform.position.x - pomerajX, levaGranica, desnaGranica),
                    Mathf.Clamp(Camera.main.transform.position.y - pomerajY, donjaGranica, gornjaGranica),
                    Camera.main.transform.position.z);
            ...
            if (released && Mathf.Abs(pomerajX) > 0.0001f)
            {
                ...
                //if(Camera.main.transform.position.x > 8.87f + 1.2f && Camera.main.transform.position.x < 31.95f - 1.2f && Camera.main.transform.position.y > -15.35f + 0.6f && Camera.main.transform.position.y < -5.2f - 0.6f)
                {
                    ...
                    pomerajY *= 0.92f;
                    Camera.main.transform.position = new Vector3(
                        Mathf.Clamp(Camera.main.transform.position.x, levaGranica, desnaGranica),
                        Mathf.Clamp(Camera.main.transform.position.y, donjaGranica, gornjaGranica),
                        Camera.main.transform.position.z);
                }
            }
        }
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            if (ShopManagerFull.ShopObject.transform.Find("3 Customize/Costumization BG/ClearAll/ClearAll_Selected")
                .GetComponent<SpriteRenderer>().enabled)
                ShopManagerFull.ShopObject.transform.Find("3 Customize/Costumization BG/ClearAll/ClearAll_Selected")
                    .GetComponent<SpriteRenderer>().enabled = false;

            if (clickedItem == releasedItem && (Time.time - trajanjeKlika < 0.35f) &&
                (Mathf.Abs(Input.mousePosition.x - pomerajOdKlika_X) < 80 &&
                 Mathf.Abs(Input.mousePosition.y - pomerajOdKlika_Y) < 80))
            {
                if (releasedItem.StartsWith("Level"))
                {
                    if (int.TryParse(releasedItem.Substring(5), out levelName))
                    {
                        ...
                        {
                            //GameObject.Find(releasedItem).transform.GetChild(0).GetComponent<Animation>().Play("LevelsLockCard");
                            ;
                        }
                        else
                        {
                            ...
                            if ((monkeyCurrentLevelIndex != monkeyDestinationLevelIndex ||
                                 StagesParser.pozicijaMajmuncetaNaMapi != Vector3.zero) && makniPopup == 0)
                            {
                            ...
                            else if (makniPopup == 0)
                            {
                                ...
                                {
                                    if (_GUI.Find(
                                            "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN")
                                ...
                                _GUI.Find("MISSION HOLDER/AnimationHolderGlavni").localPosition +=
                                    new Vector3(0, 35, 0);
                                _GUI.Find("MISSION HOLDER/AnimationHolderGlavni").GetComponent<Animator>()
                                    .Play("OpenPopup");
                                makniPopup = 1;
                            }
                        }
                ...
                else if (releasedItem.StartsWith("Kovceg"))
                {
                    ...
                    _GUI.Find(
                            "UNLOCK HOLDER/AnimationHolderGlavni/AnimationHolder/Unlock Bonus Level Popup/Text/Number of Bananas")
                        .GetComponent<TextMesh>().text = values[3];
                    _GUI.Find(
                            "UNLOCK HOLDER/AnimationHolderGlavni/AnimationHolder/Unlock Bonus Level Popup/Text/Number of Bananas")
                        .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
...
//							"OVO DA SE PREMESTI DOLE!!!!"
                ...
                else if (releasedItem.Equals("Button_UnlockBonusYES"))
                {
                    ...
                    if (int.Parse(values[2]) < zadnjiOtkljucanNivo_proveraZaBonus)
                    {
                        if (int.Parse(values[3]) <= StagesParser.currentBananas)
                        {
                            ...
                            _GUI.Find("INTERFACE HOLDER/_TopLeft/BananaHolder/Bananas/Banana Number")
                                .GetComponent<TextMesh>().text = StagesParser.currentBananas.ToString();
                            _GUI.Find("INTERFACE HOLDER/_TopLeft/BananaHolder/Bananas/Banana Number")
                                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                        ...
                        {
                            _GUI.Find("INTERFACE HOLDER/_TopLeft/BananaHolder/Bananas").GetComponent<Animation>()
                                .Play();
                        }
                    }
                    else
                ...
                else if (releasedItem.Contains("tvtv"))
                {
                    ...
                    if (StagesParser.SetsInGame[StagesParser.currSetIndex].GetStarOnStage(nivoPreTV - 1) > 0 &&
                        makniPopup == 0)
                    {
                        if (PlaySounds.soundOn)
                            PlaySounds.Play_Button_GoBack();
                        monkeyDestinationLevelIndex =
                            GetWatchVideoIndex(releasedItem.Substring(releasedItem.Length - 1));
                ...
                else if (releasedItem.Equals("ShopKucica"))
                {
                    if (StagesParser.otvaraoShopNekad == 0 || StagesParser.otvaraoShopNekad == 2)
                    {
                        ...
                        else
                        {
                            ...
                            PlayerPrefs.SetString("OdgledaoTutorial",
                                StagesParser.odgledaoTutorial.ToString() + "#" +
                                StagesParser.otvaraoShopNekad.ToString());
                            PlayerPrefs.Save();
                        }
                    }
                ...
                else if (clickedItem == releasedItem && releasedItem.StartsWith("Hats"))
                {
                    for (int i = 0; i < ShopManagerFull.ShopObject.HatsObjects.Length; i++)
                    {
                        ...
                        {
                            ObjCustomizationHats.swipeCtrl.currentValue =
                                ShopManagerFull.ShopObject.HatsObjects.Length - i - 1;
                        }
                    }
                ...
                else if (clickedItem == releasedItem && releasedItem.StartsWith("Shirts"))
                {
                    for (int i = 0; i < ShopManagerFull.ShopObject.ShirtsObjects.Length; i++)
                    {
                        ...
                        {
                            ObjCustomizationShirts.swipeCtrl.currentValue =
                                ShopManagerFull.ShopObject.ShirtsObjects.Length - i - 1;
                        }
                    }
                ...
                else if (clickedItem == releasedItem && releasedItem.StartsWith("BackPacks"))
                {
                    for (int i = 0; i < ShopManagerFull.ShopObject.BackPacksObjects.Length; i++)
                    {
                        ...
                        {
                            ObjCustomizationBackPacks.swipeCtrl.currentValue =
                                ShopManagerFull.ShopObject.BackPacksObjects.Length - i - 1;
                        }
                    }
                ...
                else if (releasedItem.Equals("Buy Button"))
                {
                    if (makniPopup == 6 && ShopManagerFull.BuyButtonState == 2)
                    {
                        ...
                        PlayerPrefs.SetString("OdgledaoTutorial",
                            StagesParser.odgledaoTutorial.ToString() + "#" + StagesParser.otvaraoShopNekad.ToString());
                        PlayerPrefs.Save();
                        makniPopup = 5;
                    }
                ...
                {
                    makniPopup = 8;
                    StartCoroutine(checkConnectionForPageLike(
                        "https://www.facebook.com/pages/Banana-Island/636650059721490", "BananaIsland"));
                ...
                {
                    makniPopup = 8;
                    StartCoroutine(checkConnectionForPageLike("https://www.facebook.com/WebelinxGamesApps",
                        "Webelinx"));
    ...
    void DodeliNagrade()
    {
        ...
        PlayerPrefs.SetString("PowerUps",
            (StagesParser.powerup_doublecoins + "#" + StagesParser.powerup_magnets + "#" +
             StagesParser.powerup_shields));
        PlayerPrefs.Save();

        GameObject.Find("Double Coins Number/Number").GetComponent<TextMesh>().text =
            StagesParser.powerup_doublecoins.ToString();
    ...
    void DajMuItem()
    {
        ...
        if (cetvrtiKovcegNagrada == "Glava")
        {
            ...
            ShopManagerFull.ShopObject.HatsObjects[indexNagradeZaCetvrtiKovceg].Find("Stikla").gameObject
                .SetActive(true);
        ...
        else if (cetvrtiKovcegNagrada == "Majica")
        {
            ...
            ShopManagerFull.ShopObject.ShirtsObjects[indexNagradeZaCetvrtiKovceg].Find("Stikla").gameObject
                .SetActive(true);
        ...
        else if (cetvrtiKovcegNagrada == "Ledja")
        {
            ...
            ShopManagerFull.ShopObject.BackPacksObjects[indexNagradeZaCetvrtiKovceg].Find("Stikla").gameObject
                .SetActive(true);
    ...
    void IspitajItem()
    {
        ...
        if (indexNagradeZaCetvrtiKovceg == -1) //nema nijednu otkljucanu glavu da mu da, ispituje majice
        {
            ...
            if (indexNagradeZaCetvrtiKovceg == -1) //nema nijednu otkljucanu majicu da mu da, ispituje ledja
            {
                ...
                if (indexNagradeZaCetvrtiKovceg ==
                    -1) //nema nijedna otkljucana ledja da mu da, daj mu po 2 od svakog powerUp-a
                {
...
//					StagesParser.svekupovineLedja = pom;
                    ...
                    {
                        if (kategorija.GetChild(i).name
                            .StartsWith("BackPacks " + (indexNagradeZaCetvrtiKovceg + 1).ToString()))
                        {
                    ...
                    if (!itemIzKategorije.Equals(System.String.Empty))
                    {
                        ...
                        _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                            .GetComponent<SpriteRenderer>().sprite = kategorija.Find(itemIzKategorije)
                            .Find("Plavi Bedz/" + samoImePredmeta + " Icon").GetComponent<SpriteRenderer>().sprite;
                    }
                }
            }
            else
...
//				StagesParser.svekupovineMajica = pom;
                ...
                {
                    if (kategorija.GetChild(i).name
                        .StartsWith("Shirts " + (indexNagradeZaCetvrtiKovceg + 1).ToString()))
                    {
                        itemIzKategorije = kategorija.GetChild(i).name;
                        break;
                    }
                ...
                if (!itemIzKategorije.Equals(System.String.Empty))
                {
                    ...
                    _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                        ...
                        .Find("Plavi Bedz/" + samoImePredmeta + " Icon").GetComponent<SpriteRenderer>().sprite;
                    _GUI.Find("REWARD HOLDER/AnimationHolderGlavni/AnimationHolder/RewardCollectPopup/Reward1")
                        .GetComponent<SpriteRenderer>().color = kategorija.Find(itemIzKategorije)
                        .Find("Plavi Bedz/" + samoImePredmeta + " Icon").GetComponent<SpriteRenderer>().color;
                }
            }
        }
        else
...
//			StagesParser.svekupovineGlava = pom;
    ...
    int findAngleDir(Transform start, Vector3 target)
    {
        ...
        if (dif != Vector3.zero)
        {
            float angle = (dif.y <= start.right.y)
                ? Vector3.Angle(start.right, dif)
                : 360 - Vector3.Angle(start.right, dif);
            ...
            for (int i = koraciDoKovcega.childCount - 1; i >= 0; i--)
            {
                ...
                while (holderMajmun.position != koraciDoKovcega.GetChild(i).position)
                {
                    if (!PlaySounds.Run.isPlaying && PlaySounds.soundOn)
                        PlaySounds.Play_Run();
                    holderMajmun.position = Vector3.MoveTowards(holderMajmun.position,
                        koraciDoKovcega.GetChild(i).position, brzina);
                    yield return null;
                    if (angleDir != -1)
                        majmun.rotation = Quaternion.Lerp(majmun.rotation, a, 0.2f);
                }
        ...
        if (monkeyCurrentLevelIndex < monkeyDestinationLevelIndex) // od manjeg nivoa ka vecem
        {
            for (int i = monkeyCurrentLevelIndex; i <= monkeyDestinationLevelIndex; i++)
            {
                ...
                while (holderMajmun.position != izmedjneTacke.GetChild(i).position && !izadji)
                {
                    if (!PlaySounds.Run.isPlaying && PlaySounds.soundOn)
                        PlaySounds.Play_Run();
                    holderMajmun.position =
                        Vector3.MoveTowards(holderMajmun.position, izmedjneTacke.GetChild(i).position, brzina);
                    yield return null;
                    ...
                    if (izmedjneTacke.GetChild(i).name.Contains("tvtv") &&
                        izmedjneTacke.GetChild(i).gameObject.activeSelf &&
                        !prejasiTelevizor) // && trenutniTelevizor == int.Parse(izmedjneTacke.GetChild(i).name.Substring(izmedjneTacke.GetChild(i).name.Length-1)))
                    {
                        ...
                        izadji = true;
                        trenutniTelevizor = int.Parse(izmedjneTacke.GetChild(i).name
                            .Substring(izmedjneTacke.GetChild(i).name.IndexOf("tvtv") + 4));
                        animator.Play("Idle");
...
//			}
            ...
            while (t < 1)
            {
                Camera.main.transform.position = Vector3.Lerp(Camera.main.transform.position,
                    new Vector3(holderMajmun.position.x, holderMajmun.position.y, Camera.main.transform.position.z), t);
                t += Time.deltaTime;
                yield return null;
            }

            Camera.main.transform.position =
                new Vector3(Mathf.Clamp(Camera.main.transform.position.x, levaGranica, desnaGranica),
                    Mathf.Clamp(Camera.main.transform.position.y, donjaGranica, gornjaGranica),
                    Camera.main.transform.position.z);
            if (kretanjeDoKovcega)
            {
            ...
            if (!StagesParser.bonusLevel)
            {
                if (!FB.IsLoggedIn)
                {
                    if (_GUI.Find("MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN")
                        .gameObject.activeSelf)
                        _GUI.Find("MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN")
                            .gameObject.SetActive(false);
                }
                else
                {
        ...
        else if (televizorNaMapi)
        {
            ...
            animator.Play("Idle");
            _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/Coins/Coins Number")
                .GetComponent<TextMesh>().text = StagesParser.currentMoney.ToString();
            _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/Coins/Coins Number")
                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
        ...
        else
        {
            ...
            {
                Camera.main.transform.position = Vector3.Lerp(Camera.main.transform.position,
                    new Vector3(limitX, holderMajmun.position.y, Camera.main.transform.position.z), t);
                t += Time.deltaTime;
                yield return null;
            }
            ...
            if (!FB.IsLoggedIn)
            {
                if (_GUI.Find("MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN").gameObject
                    .activeSelf)
                    _GUI.Find("MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN").gameObject
                        .SetActive(false);
            }
            else
            {
    ...
    void ocistiMisije()
    {
        Transform missionPopup =
            _GUI.Find("MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Popup za Mission HOLDER/Popup za Mission");
    ...
    private IEnumerator PlayAndWaitForAnimation(Animation animation, string animName, bool loadAnotherScene,
        int indexOfSceneToLoad)
    {
        //GameObject.Find("HolderLife").transform.parent = lifeManager.GetChild(0);
//		animation.Play();
//		
...
//		while ( animation.IsPlaying(animName) );
    ...
    {
        TutorialShop =
            Instantiate(TutorialShopPrefab, new Vector3(-33.2f, -95f, -60), Quaternion.identity) as GameObject;
        ...
        while (Camera.main.transform.position.y <= -18.45f)
        {
            Camera.main.transform.position = Vector3.MoveTowards(Camera.main.transform.position,
                new Vector3(Camera.main.transform.position.x, -18.4f, Camera.main.transform.position.z), 0.055f);
            yield return null;
        }
    ...
    void changeLanguage()
    {
        ...
        _GUI.Find(
                "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win 1 HOLDER/FB/Fb Invite 1")
            .GetComponent<TextMesh>().text = LanguageManager.Invite;
        _GUI.Find(
                "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win 2 HOLDER/FB/Fb Invite 1")
            .GetComponent<TextMesh>().text = LanguageManager.Invite;
        _GUI.Find(
                "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win 3 HOLDER/FB/Fb Invite 1")
            .GetComponent<TextMesh>().text = LanguageManager.Invite;
        _GUI.Find(
                "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win 4 HOLDER/FB/Fb Invite 1")
            .GetComponent<TextMesh>().text = LanguageManager.Invite;
        _GUI.Find(
                "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win 5 HOLDER/FB/Fb Invite 1")
            .GetComponent<TextMesh>().text = LanguageManager.Invite;
        _GUI.Find(
                "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win 1 HOLDER/FB/Fb Invite 1")
            .GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
        ...
        GameObject.Find("Button_WatchVideoNO/Text").GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
        _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/WatchVideoText")
            .GetComponent<TextMesh>().text = LanguageManager.WatchVideo;
        _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/WatchVideoText")
            .GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
        _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/NotAvailableText")
            .GetComponent<TextMesh>().text = LanguageManager.NoVideo;
        _GUI.Find("WATCH VIDEO HOLDER/AnimationHolderGlavni/AnimationHolder/WATCH VIDEO Popup/NotAvailableText")
            .GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
        ...
        GameObject.Find("ShopFCWatchVideo/Text/Watch Video").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);
...
//		GameObject.Find ("ButtonPreview").GetComponent<TextMeshEffects>().RefreshTextOutline(true,true);
        ...
        GameObject.Find("Shop POWERUP Double Coins/Text/ime").GetComponent<TextMesh>().text =
            LanguageManager.DoubleCoins;
        GameObject.Find("Shop POWERUP Double Coins/Text/ime").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);
    ...
    void getFriendsScoresOnLevel(int level)
    {
        if (!popunioSlike)
        {
            ...
            for (int i = 0; i < FacebookManager.ListaStructPrijatelja.Count; i++)
            {
                ...
                {
                    if (FacebookManager.ListaStructPrijatelja[i].PrijateljID ==
                        FacebookManager.ProfileSlikePrijatelja[j].PrijateljID)
                    {
        ...
        for (int i = 0; i < FacebookManager.ListaStructPrijatelja.Count; i++)
        {
            ...
            if (level <= FacebookManager.ListaStructPrijatelja[i].scores.Count) //@@@@@@ DODATAK ZA NOVA OSTRVA
            {
                ...
                if (pom.score == 0 &&
                    FacebookManager.ListaStructPrijatelja[i].PrijateljID !=
                    FacebookManager
                        .User) // lokalno u listi smanjiti score igraca koji nisu stigli do nekog nivoa zbog sortiranja posle, da ne izbacuje prvo invite pa usera
                    pom.score = -1;
...
//		}
        ...
        for (int i = 0; i < scoresAndIndexes.Count; i++) //scoresAndIndexes.Count
        {
            ...
            if (i < 5)
            {
                if (scoresAndIndexes[i].score > 0 ||
                    FacebookManager.ListaStructPrijatelja[scoresAndIndexes[i].index].PrijateljID ==
                    FacebookManager.User)
                {
                    ...
                    trenutniPrijatelj.Find("Friends Level Win " + redosled + "/Friends Level Win Picture " + redosled)
                        .GetComponent<Renderer>().material.mainTexture = FacebookManager
                        .ListaStructPrijatelja[scoresAndIndexes[i].index].profilePicture;
                    trenutniPrijatelj
                            .Find("Friends Level Win " + redosled + "/Friends Level Win Picture " + redosled +
                                  "/Points Number level win fb").GetComponent<TextMesh>().text =
                        scoresAndIndexes[i].score.ToString();
                    if (FacebookManager.ListaStructPrijatelja[scoresAndIndexes[i].index].PrijateljID ==
                        FacebookManager.User)
                    {
                        korisnik = true;
                        trenutniPrijatelj.Find("Friends Level Win " + redosled).GetComponent<SpriteRenderer>().sprite =
                            trenutniPrijatelj.parent.Find("ReferencaYOU").GetComponent<SpriteRenderer>().sprite;
                    }
                    else
                    {
                        trenutniPrijatelj.Find("Friends Level Win " + redosled).GetComponent<SpriteRenderer>().sprite =
                            trenutniPrijatelj.parent.Find("Referenca").GetComponent<SpriteRenderer>().sprite;
                    }
                }
                else
                {
                    if (redosled <= 5)
                    {
                        _GUI.Find(
                            "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win " +
                            redosled + " HOLDER/FB").gameObject.SetActive(true);
                        _GUI.Find(
                            "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win " +
                            redosled + " HOLDER/Friends Level Win " + redosled).gameObject.SetActive(false);
                    }
                }
            }
        ...
        if (scoresAndIndexes.Count < 5)
        {
            ...
            {
                _GUI.Find(
                    "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win " + i +
                    " HOLDER/Friends Level Win " + i).gameObject.SetActive(false);
            }
        }
        ...
        if (!korisnik)
        {
            trenutniPrijatelj =
                _GUI.Find(
                    "MISSION HOLDER/AnimationHolderGlavni/AnimationHolder/Friends FB level WIN/Friends Level Win 5 HOLDER");
            trenutniPrijatelj.Find("Friends Level Win 5/Friends Level Win Picture 5").GetComponent<Renderer>().material
                .mainTexture = FacebookManager.ListaStructPrijatelja[scoresAndIndexes[pozicijaKorisnika - 1].index]
                .profilePicture;
            trenutniPrijatelj.Find("Friends Level Win 5/Friends Level Win Picture 5/Points Number level win fb")
                .GetComponent<TextMesh>().text = scoresAndIndexes[pozicijaKorisnika - 1].score.ToString();
            trenutniPrijatelj.Find("Friends Level Win 5/Friends Level Win Picture 5/Position Number")
                .GetComponent<TextMesh>().text = pozicijaKorisnika.ToString();
            trenutniPrijatelj.Find("Friends Level Win 5").GetComponent<SpriteRenderer>().sprite =
                trenutniPrijatelj.parent.Find("ReferencaYOU").GetComponent<SpriteRenderer>().sprite;
        }
    ...
    void spustiPopup()
    {
        ...
        popupZaSpustanje =
            null; //izbacio je ovde null reference exception, treba na nekom mestu da se proveri da li je popup razlicit od null
    }
...
//			}
                    ...
                    resultCallback = result =>
                    {
                        ...
                        if (result.ToString().Equals("Finished"))
                        {
                            if (StagesParser.sceneID == 0)
                            {
                                ...
                                PlayerPrefs.SetInt("TotalMoney", StagesParser.currentMoney);
                                PlayerPrefs.Save();
                                StartCoroutine(StagesParser.Instance.moneyCounter(StagesParser.watchVideoReward,
                                    ShopManagerFull.ShopObject.transform.Find("Shop Interface/Coins/Coins Number")
                                        .GetComponent<TextMesh>(), true));
                            }
                            else if (StagesParser.sceneID == 1)
                            {
                                Camera.main.SendMessage("WatchVideoCallback", 1,
                                    SendMessageOptions.DontRequireReceiver);
                            }
                            else if (StagesParser.sceneID == 2)
                            {
                                GameObject.Find("_GameManager").SendMessage("WatchVideoCallback",
                                    SendMessageOptions.DontRequireReceiver);
                            }
    ...
    IEnumerator checkConnectionForTelevizor()
    {
        ...
        if (CheckInternetConnection.Instance.internetOK)
        {
            ...
            {
                Televizori[trenutniTelevizor - 1].gameObject.SetActive(false);
                PlayerPrefs.SetString("WatchVideoWorld" + (StagesParser.currSetIndex + 1),
                    trenutniTelevizor.ToString());
                PlayerPrefs.Save();
            }
    ...
    public void WatchVideoCallback(int value)
    {
        if (value == 1) //finished
        {
            if (makniPopup == 0) //watch video popup
            {
                ...
                PlayerPrefs.SetInt("TotalMoney", StagesParser.currentMoney);
                PlayerPrefs.Save();
                StartCoroutine(StagesParser.Instance.moneyCounter(televizorCenePoSvetovima[StagesParser.currSetIndex],
                    _GUI.Find("INTERFACE HOLDER/_TopLeft/Coins/Coins Number").GetComponent<TextMesh>(), true));
                StagesParser.ServerUpdate = 1;
            }
