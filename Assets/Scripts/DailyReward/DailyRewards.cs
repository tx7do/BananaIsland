...
//			godinaIzlaska="2014";
            ...
            Debug.Log("Vreme izlaska je: " + lastPlayDate + " danIzlaska: " + danIzlaska + " mesecIzlaska: " +
                      mesecIzlaska);
            ...
            if ((int.Parse(godinaUlaska) - int.Parse(godinaIzlaska)) < 1)
            {
                ...
                else
                {
                    ...
                    {
                        if (int.Parse(mesecIzlaska) == 1 || int.Parse(mesecIzlaska) == 3 ||
                            int.Parse(mesecIzlaska) == 5 || int.Parse(mesecIzlaska) == 7 ||
                            int.Parse(mesecIzlaska) == 8 || int.Parse(mesecIzlaska) == 10 ||
                            int.Parse(mesecIzlaska) == 12)
                        {
                            ...
                            if (int.Parse(danIzlaska) == 31)
                            {
                                ...
                                {
                                    LevelReward = 1;
                                    Debug.Log("Dobio si nagradu! Prelazak iz meseca u mesec i proslo 6 dana:" +
                                              LevelReward);
                                    GameObject.Find("DailyReward").GetComponent<Animation>().Play("DailyDolazak");
                        ...
                        else if (int.Parse(mesecIzlaska) == 4 || int.Parse(mesecIzlaska) == 6 ||
                                 int.Parse(mesecIzlaska) == 9 || int.Parse(mesecIzlaska) == 11)
                        {
