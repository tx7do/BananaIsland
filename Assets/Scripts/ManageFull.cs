...
public class ManageFull : MonoBehaviour
{
    ...
    [HideInInspector] public int collectedPoints = 0;
    [HideInInspector] public int baboonSmashed = 0;
    ...
    GameObject keyHole2;
    GameObject keyHole3;
    [HideInInspector] public Transform progressBarScale;
    Transform wonStar1;
    Transform wonStar2;
    Transform wonStar3;
...
//		GameObject.Find("TextPauseHeader1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextPauseHeader2").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("FailedTextHeader1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("FailedTextHeader2").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextEarnCoins1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextEarnCoins2").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextKeyInfo1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextPts").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextKeyPrice1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextKeyPrice2").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TaxtNewScore1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TaxtNewScore2").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextKeepPlayingHeader1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextKeepPlayingHeader2").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextEnd1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextEnd2").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextCoins").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextPtsGameplay").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextKeepPlayingHeader1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextFreeCoinsUp1").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextShopDown").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextShopUp").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextFreeCoinsUp").GetComponent<Renderer>().sortingLayerID = 1;
//		GameObject.Find("TextFreeCoinsDown").GetComponent<Renderer>().sortingLayerID = 1;
        ...
        pauseButton.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.one).x,
            Camera.main.ViewportToWorldPoint(Vector3.one).y, pauseButton.position.z);
        coinsHolder.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.zero).x,
            Camera.main.ViewportToWorldPoint(Vector3.one).y, coinsHolder.position.z);
        holderKeys.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.one / 2).x,
            Camera.main.ViewportToWorldPoint(Vector3.one).y, pauseButton.position.z);

        shopHolder.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.one / 2).x, shopHolder.position.y,
            shopHolder.position.z);
        shopLevaIvica.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.zero).x, shopLevaIvica.position.y,
            shopLevaIvica.position.z);
        shopDesnaIvica.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.one).x, shopLevaIvica.position.y,
            shopLevaIvica.position.z);
        ...
        PickPowers.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.one / 2).x,
            Camera.main.ViewportToWorldPoint(Vector3.one).y * 0.65f, PickPowers.position.z);
        PickPowers.gameObject.SetActive(false);

        goScreen.transform.position = new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y,
            goScreen.transform.position.z);
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0)) // || Input.GetKeyDown(KeyCode.Space))
        {
            ...
            if (releasedItem == "GO screen")
            {
                ...
                goScreen2.SetActive(false);
                playerController.state = MonkeyController2D.State.running;
                GameObject.Find("PrinceGorilla").GetComponent<Animator>()
                    .SetBool("Run", true); //MOZDA DA SE VRATI U PrinceGorilla
                PlaySounds.Play_Run();
            ...
            else if (releasedItem == "ButtonPause")
            {
                ...
                //pauseButton.GetChild(0).GetComponent<Animation>().Play();
                pauseScreenHolder.transform.position = new Vector3(Camera.main.transform.position.x,
                    Camera.main.transform.position.y, pauseScreenHolder.transform.position.z);
            ...
            else if (releasedItem == "FailedMainHole") // KLIKNUTO NA MAIN DUGME IZ FAILED MENIJA
            {
                ...
                StartCoroutine(FailedScreenHolder.transform.GetChild(0).GetComponent<Animation>()
                    .Play("FailedGo", false, what => { helpBool = true; }));
            ...
            else if (releasedItem == "ButtonRestart1") // KLIKNUTO NA RESTART DUGME IZ FINISH MENIJA
            {
                ...
                temp.GetComponent<Animation>().Play("FinishButtonsClick");
                command = delegate { Application.LoadLevel(Application.loadedLevel); };
                StartCoroutine(Win_CompletedScreenHolder.transform.GetChild(0).GetComponent<Animation>()
                    .Play("FinishTableGo1", false, what => { helpBool = true; }));
                StartCoroutine(DoAfterAnimation(temp, "FinishButtonsClick"));
            }
            ...
            {
                GameObject.Find(releasedItem).transform.GetChild(0).GetComponent<Animation>()
                    .Play("FinishButtonsClick");
                shopHolder.transform.position = Camera.main.transform.position + Vector3.forward * 5;
                StartCoroutine(OpenFreeCoinsCard());
            }
    ...
    {
        StartCoroutine(pauseButton.transform.GetChild(0).GetComponent<Animation>()
            .Play("FinishButtonsClick", false, what => { helpBool = true; }));
        StartCoroutine(pauseScreenHolder.transform.GetChild(0).GetComponent<Animation>()
            .Play("PauseShow", false, what => { helpBool = true; }));
        while (!helpBool)
        {
            yield return null;
        }
    ...
    IEnumerator dropPauseScreen()
    {
        StartCoroutine(pauseButton.transform.GetChild(0).GetComponent<Animation>()
            .Play("FinishButtonsClick", false, what => { helpBool = true; }));
        StartCoroutine(pauseScreenHolder.transform.GetChild(0).GetComponent<Animation>()
            .Play("PauseGo", false, what => { helpBool = true; }));
        while (!helpBool)
        {
            yield return null;
        }
    ...
    {
        StartCoroutine(GameObject.Find("ButtonMain_Pause").GetComponent<Animation>()
            .Play("FinishButtonsClick", false, what => { helpBool = true; }));
        StartCoroutine(pauseScreenHolder.transform.GetChild(0).GetComponent<Animation>()
            .Play("PauseGo", false, what => { helpBool = true; }));
        while (!helpBool)
    ...
    {
        StartCoroutine(GameObject.Find("ButtonRestart_Pause").GetComponent<Animation>()
            .Play("FinishButtonsClick", false, what => { helpBool = true; }));
        StartCoroutine(pauseScreenHolder.transform.GetChild(0).GetComponent<Animation>()
            .Play("PauseGo", false, what => { helpBool = true; }));
        while (!helpBool)
    ...
    IEnumerator unPause()
    {
        StartCoroutine(GameObject.Find("ButtonPlay_Pause").GetComponent<Animation>()
            .Play("FinishButtonsClick", false, what => { helpBool = true; }));
        StartCoroutine(dropPauseScreen());
        while (!helpBool)
        {
    ...
    void showFailedScreen()
    {
        ...
        FailedScreenHolder.transform.position = new Vector3(Camera.main.transform.position.x,
            Camera.main.transform.position.y, FailedScreenHolder.transform.position.z);
    ...
    void ShowWinScreen()
    {
        ...
        Win_CompletedScreenHolder.transform.position = new Vector3(Camera.main.transform.position.x,
            Camera.main.transform.position.y - 3, Win_CompletedScreenHolder.transform.position.z);
        Win_CompletedScreenHolder.SetActive(true);
        Win_ShineHolder.transform.position = new Vector3(Camera.main.transform.position.x,
            Camera.main.transform.position.y, Win_ShineHolder.transform.position.z);
    ...
    public void AddPoints(int value)
    {
        ...
        if ( /*collectedPoints <= 1000 && */
            coinsCollected <= 100 && baboonSmashed <= 20 && progressBarScale.localScale.y <= 1)
        {
            ...
            //progressBarScale.GetChild(0).GetChild(0).GetComponent<Renderer>().material.mainTextureScale = new Vector2(1,progressBarScale.GetChild(0).GetChild(0).GetComponent<Renderer>().material.mainTextureScale.y + value/1000f);
...
//		}
        if (progressBarScale.localScale.y >= 1)
        {
            ...
            progressBarScale.GetChild(0).GetChild(0).GetComponent<Renderer>().material.mainTextureScale =
                new Vector2(1, 1);
        }
    }
    ...
    IEnumerator graduallyFillScale(float value)
    {
        ...
        while (t < result)
        {
            yield return null;
            if (progressBarScale.localScale.y <= 1)
                progressBarScale.localScale = Vector3.Lerp(progressBarScale.localScale,
                    new Vector3(progressBarScale.localScale.x, result, progressBarScale.localScale.z), 0.2f);
            t += Time.deltaTime * 2;
    ...
    IEnumerator graduallyFillTile(float value)
    {
        ...
        float result = progressBarScale.GetChild(0).GetChild(0).GetComponent<Renderer>().material.mainTextureScale.y +
                       value;
        float t = 0;
        while (t < result)
        {
