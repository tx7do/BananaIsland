...
public class AllMapsManageFull : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        Camera.main.transform.position =
            new Vector3(
                Mathf.Clamp(GameObject.Find(StagesParser.worldToFocus.ToString()).transform.position.x, levaGranica,
                    desnaGranica), Camera.main.transform.position.y, Camera.main.transform.position.z);
    }
    ...
    void RefreshScene()
    {
        ...
        _GUI.Find("_TopLeft/Bananas/Banana Number").GetComponent<TextMesh>().text =
        ...
        {
            GameObject.Find("AllWorlds_holder/" + i.ToString() + "/TotalStars/Stars Number")
...
//			GameObject.Find("AllWorlds_holder").transform.Find(i.ToString()+"/LevelsHolder/LevelValue").GetComponent<TextMeshEffects>().RefreshTextOutline(false,true);//DODATO!!!
            if (i > 0 && GameObject.Find("AllWorlds_holder").transform.Find("HolderClouds" + (i).ToString()).gameObject
                    .activeSelf)
            {
                GameObject.Find("AllWorlds_holder").transform
                    .Find("HolderClouds" + (i).ToString() + "/CloudsMove/AllMapsKatanac/Stars Number")
                    .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                GameObject.Find("AllWorlds_holder").transform
                    .Find("HolderClouds" + (i).ToString() + "/CloudsMove/AllMapsKatanac/Level Text")
                    .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                GameObject.Find("AllWorlds_holder").transform.Find(i.ToString() + "/LevelsHolder").gameObject
                    .SetActive(false);
    ...
    void Start()
    {
        ...
        {
            _GUI.parent.Find("LOADING HOLDER NEW/Loading Animation Vrata").GetComponent<Animator>()
        ...
        _GUI.Find("_TopLeft").position = new Vector3(guiCamera.ViewportToWorldPoint(Vector3.zero).x,
            _GUI.Find("_TopLeft").position.y, _GUI.Find("_TopLeft").position.z);
        _GUI.Find("FB Login").position = new Vector3(guiCamera.ViewportToWorldPoint(new Vector3(0.91f, 0, 0)).x,
            _GUI.Find("FB Login").position.y, _GUI.Find("FB Login").position.z);
        _GUI.Find("TotalStars").position = new Vector3(guiCamera.ViewportToWorldPoint(new Vector3(0.89f, 0, 0)).x,
            _GUI.Find("TotalStars").position.y, _GUI.Find("TotalStars").position.z);
        ...
        for (int i = 0; i < StagesParser.totalSets; i++)
        {
            GameObject.Find("AllWorlds_holder/" + i.ToString() + "/TotalStars/Stars Number")
                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
            GameObject.Find("AllWorlds_holder/" + i.ToString() + "/LevelsHolder/LevelText")
                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
            GameObject.Find("AllWorlds_holder/" + i.ToString() + "/LevelsHolder/LevelValue")
                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
            if (i > 0 && GameObject.Find("AllWorlds_holder").transform.Find("HolderClouds" + (i).ToString()).gameObject
                    .activeSelf)
            {
    ...
    {
        Transform temp = GameObject.Find("AllWorlds_holder").transform
            .Find("HolderClouds" + (index).ToString() + "/CloudsMove/AllMapsKatanac").transform;
    ...
    {
        GameObject levelsHolder = GameObject.Find("AllWorlds_holder").transform.Find(index.ToString() + "/LevelsHolder")
            .gameObject;
        //if(!levelsHolder.activeSelf)
        {
            levelsHolder.SetActive(true);
            levelsHolder.transform.Find("LevelText").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true); //DODATO!!!
            levelsHolder.transform.Find("LevelValue").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true); //DODATO!!!
        }
    }
                        ...
                        if (int.Parse(values[1]) > 0)
                        {
                            ...
                            else
                            {
                                ...
                                if (StagesParser.lastUnlockedWorldIndex == 5 && FB.IsLoggedIn)
                                {
                                    ...
                                    {
                                        if (FacebookManager.ListaStructPrijatelja[ii].PrijateljID
                                            .Equals(FacebookManager.User))
                                        {
                                            if (FacebookManager.ListaStructPrijatelja[ii].scores.Count <
                                                StagesParser.allLevels.Length)
                                            {
                                                for (int j = FacebookManager.ListaStructPrijatelja[ii].scores.Count;
                                                     j < StagesParser.allLevels.Length;
                                                     j++)
...
//				}
            ...
            GameObject.Find("AllWorlds_holder/" + i.ToString() + "/TotalStars/Stars Number").GetComponent<TextMesh>()
                    .text = StagesParser.SetsInGame[i].CurrentStarsInStageNEW + "/" +
                            StagesParser.SetsInGame[i].StagesOnSet * 3;
            GameObject.Find("AllWorlds_holder").transform.Find(i.ToString() + "/LevelsHolder/LevelText")
                .GetComponent<TextMesh>().text = LanguageManager.Level;
            GameObject.Find("AllWorlds_holder").transform.Find(i.ToString() + "/LevelsHolder/LevelValue")
                .GetComponent<TextMesh>().text = StagesParser.maxLevelNaOstrvu[i] + "/20";
            if (i > 0)
            {
                GameObject.Find("AllWorlds_holder").transform
                    .Find("HolderClouds" + (i).ToString() + "/CloudsMove/AllMapsKatanac/Stars Number")
                    .GetComponent<TextMesh>().text = StagesParser.SetsInGame[i].StarRequirement.ToString();
                GameObject.Find("AllWorlds_holder").transform
                    .Find("HolderClouds" + (i).ToString() + "/CloudsMove/AllMapsKatanac/Level Text")
                    .GetComponent<TextMesh>().text = LanguageManager.Level;
            }
        ...
        _GUI.Find("TotalStars/Stars Number").GetComponent<TextMesh>().text =
            StagesParser.currentStarsNEW + "/" + StagesParser.totalStars;
...
//		}
        ...
        if (Input.GetMouseButton(0) && makniPopup == 0)
        {
            ...
            Camera.main.transform.position = new Vector3(
                Mathf.Clamp(
                    Mathf.Lerp(Camera.main.transform.position.x, Camera.main.transform.position.x - pomerajX, 0.75f),
                    levaGranica, desnaGranica), Camera.main.transform.position.y, Camera.main.transform.position.z);
            startX = endX;
        }
...
//			}
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            if (clickedItem == releasedItem && (Time.time - vremeKlika < 0.35f) && Mathf.Abs(razlikaX) < 40 &&
                Mathf.Abs(razlikaY) < 40)
            {
                if (RaycastFunction(Input.mousePosition) == "0")
                {
