...
public class MainMenuManage : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        dock_doleDesno.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.one).x,
            Camera.main.ViewportToWorldPoint(Vector3.zero).y, holderLogo.transform.position.z);
        dock_doleLevo.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.zero).x,
            Camera.main.ViewportToWorldPoint(Vector3.zero).y, holderLogo.transform.position.z);
        dock_goreDesno.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.one).x,
            Camera.main.ViewportToWorldPoint(Vector3.one).y, holderLogo.transform.position.z);
        dock_goreLevo.position = new Vector3(Camera.main.ViewportToWorldPoint(Vector3.zero).x,
            Camera.main.ViewportToWorldPoint(Vector3.one).y, holderLogo.transform.position.z);
    ...
    void Start()
    {
        ...
        {
            GameObject.Find("ButtonFreeCoinsDock").transform.position =
                GameObject.Find("ButtonShop").transform.position;
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (clickedItem.Equals("PlayMain") || clickedItem.Equals("PlayMainFly") ||
                clickedItem.Equals("ButtonFreeCoins") || clickedItem.Equals("ButtonShop") ||
                clickedItem.Equals("ButtonExit"))
            {
