	...
	public void KupiItem()
	{
		...
		else if(BuyButtonState==2)
		{
			...
			else if(AktivanCustomizationTab==2)
			{
				...
				MajmunBobo.transform.Find("PrinceGorilla/custom_Majica").renderer.material.SetTexture("_MainTex", MajicaTekstura);
				MajmunBobo.transform.Find("PrinceGorilla/custom_Majica").renderer.material.color = TShirtColors[AktivanItemMajica];
...
//			AktivanSesir=-1;
		...
		if(AktivnaMajica!=-1)
		{
			...
			MajmunBobo.transform.Find("PrinceGorilla/custom_Majica").renderer.material.SetTexture("_MainTex", MajicaTekstura);
			MajmunBobo.transform.Find("PrinceGorilla/custom_Majica").renderer.material.color = TShirtColors[AktivnaMajica];
//			AktivnaMajica=-1;
			TrenutnoSelektovanaMajica=-1;
			ProveraTrenutnogItema(AktivanItemMajica);
		}
