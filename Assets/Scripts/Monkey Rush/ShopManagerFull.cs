...
//	public static List<int> SveStvariZaOblacenje=new List<int>();
    ...
    public static int BrojOtkljucanihMajici,
        BrojOtkljucanihRanceva,
        BrojOtkljucanihKapa,
        StariBrojOtkljucanihMajici,
        StariBrojOtkljucanihRanceva,
        StariBrojOtkljucanihKapa;
...
//		//Debug.Log ("Aspect: "+Camera.main.aspect);
        ...
        GameObject.Find("Shop/2 Shop - BANANA/Zid Shop/Zid Header i Footer/Zid Footer Shop/Banana Number/Number")
        ...
        BrojItemaShopHats =
            CountItemsInShop(GameObject.Find("Shop/3 Customize/Customize Tabovi/1Hats").GetComponent<Transform>());
        BrojItemaShopShirts =
            CountItemsInShop(GameObject.Find("Shop/3 Customize/Customize Tabovi/2Shirts").GetComponent<Transform>());
        BrojItemaShopBackPack =
            CountItemsInShop(GameObject.Find("Shop/3 Customize/Customize Tabovi/3BackPack").GetComponent<Transform>());
...
//		chosenLanguage="_en";
    ...
    void Update()
    {
        ...
        if (ObjCustomizationHats.CustomizationHats || ObjCustomizationShirts.CustomizationShirts ||
            ObjCustomizationBackPacks.CustomizationBackPacks)
        {
...
//						KosaHats.Add((string)xmls.ElementAt(i).Attribute("kosa").Value);
                    if (SveStvariZaOblacenjeHats[i] == 1) // Kupljen je
                    {
                        HatsObjects[i].Find("Polje za unos COINA U shopu - Shop").gameObject.SetActive(false);
                        HatsObjects[i].Find("Bedz - Popust").gameObject.SetActive(false);
                        HatsObjects[i].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                            .SetActive(false);
                    }
                    else
                    {
                        if (PopustHats[i] == "0")
                        {
                            HatsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                .GetComponent<TextMesh>().text = CoinsHats[i];
                            HatsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
...
//									//Debug.Log("Kapa sa indeksom "+i+" je novi element posto je "+i+">"+StariBrojOtkljucanihKapa+" i "+i+"<"+BrojOtkljucanihKapa);
                                ImaNovihKapa = true;
                                HatsObjects[i].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                                    LanguageManager.New;
                                HatsObjects[i].Find("Bedz - Popust/Text/Number/Number Shadow").GetComponent<TextMesh>()
                                    .text = LanguageManager.New;
                            }
                            else
                            {
...
//									//Debug.Log("Kapa sa indeksom "+i+" je novi element posto je "+i+">"+StariBrojOtkljucanihKapa+" i "+i+"<"+BrojOtkljucanihKapa );
                                ...
                                if (ZakljucaniHats[i] == 1)
                                {
                                    HatsObjects[i].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                                        .SetActive(true);
                                    HatsObjects[i].Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number")
                                        .GetComponent<TextMesh>().text = CoinsHats[i];
                                    if (HatsObjects[i]
                                        .Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number").gameObject
                                        .activeSelf)
                                        HatsObjects[i]
                                            .Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number")
                                            .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);

                                    string popust = "0." + PopustHats[i];
                                    float cena = float.Parse(CoinsHats[i]) -
                                                 float.Parse(CoinsHats[i]) * float.Parse(popust);
                                    CoinsHats[i] = cena.ToString();
                                    HatsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                        .GetComponent<TextMesh>().text = cena.ToString();
                                    HatsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                        .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                                    HatsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                        .GetComponent<TextMesh>().color = PopustBoja;
                                }
                            }
                            else
                            {
//									//Debug.Log("Kapa sa indeksom "+i+" nije novi element");
                                if (ZakljucaniHats[i] == 1)
                                {
                                    ...
                                    HatsObjects[i].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                                        "-" + PopustHats[i] + "%";
                                    HatsObjects[i].Find("Bedz - Popust/Text/Number/Number Shadow")
                                        .GetComponent<TextMesh>().text = PopustHats[i] + "%";
            ...
            for (int j = 0; j < BrojItemaShopShirts; j++)
            {
                ...
                if (xmls.ElementAt(BrojItemaShopHats + j).Attribute("kategorija").Value == "Shirts")
                {
                    ...
                    if (SveStvariZaOblacenjeShirts[j] == 1)
                    {
                        ShirtsObjects[j].Find("Polje za unos COINA U shopu - Shop").gameObject.SetActive(false);
                        ShirtsObjects[j].Find("Bedz - Popust").gameObject.SetActive(false);
                        ShirtsObjects[j].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                            .SetActive(false);
                    }
                    else
                    {
                        if (PopustShirts[j] == "0")
                        {
                            ShirtsObjects[j].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                .GetComponent<TextMesh>().text = CoinsShirts[j];
                            ShirtsObjects[j].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
...
//									//Debug.Log("Majica sa indeksom "+j+" je novi element posto je "+j+">"+StariBrojOtkljucanihMajici+" i "+j+"<"+BrojOtkljucanihMajici);
                                ImaNovihMajica = true;
                                ShirtsObjects[j].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                                    LanguageManager.New;
                                ShirtsObjects[j].Find("Bedz - Popust/Text/Number/Number Shadow")
                                    .GetComponent<TextMesh>().text = LanguageManager.New;
                            }
                            else
                            {
...
//									//Debug.Log("Majica sa indeksom "+j+" je novi element posto je "+j+">"+StariBrojOtkljucanihMajici+" i "+j+"<"+BrojOtkljucanihMajici );
                                ...
                                if (ZakljucaniShirts[j] == 1)
                                {
                                    ...
                                    ShirtsObjects[j].Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number")
                                        .GetComponent<TextMesh>().text = CoinsShirts[j].ToString();
                                    ...
                                    float cena = float.Parse(CoinsShirts[j]) -
                                                 float.Parse(CoinsShirts[j]) * float.Parse(popust);
...
//									//Debug.Log("Kapa sa indeksom "+j+" nije novi element");
                                if (ZakljucaniShirts[j] == 1)
                                {
                                    ...
                                    ShirtsObjects[j].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                                        "-" + PopustShirts[j] + "%";
                                    ShirtsObjects[j].Find("Bedz - Popust/Text/Number/Number Shadow")
                                        .GetComponent<TextMesh>().text = PopustShirts[j] + "%";
...
//						//Debug.Log("Ime itema broj "+j+" je :"+ImenaShirts[j]);
            ...
            for (int k = 0; k < BrojItemaShopBackPack; k++)
            {
                ...
                else
                {
                    ...
                    BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                        .SetActive(false);
                }

                if (xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + k).Attribute("kategorija").Value ==
                    "BackPack")
                {
                    ImenaBackPacks.Add((string) xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + k).Value);
                    CoinsBackPacks.Add((string) xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + k)
                        .Attribute("coins").Value);
                    BananaBackPacks.Add((string) xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + k)
                        .Attribute("banana").Value);
                    PopustBackPacks.Add((string) xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + k)
                        .Attribute("popust").Value);
                    ...
                    else
                    {
                        ...
                        {
                            BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                .GetComponent<TextMesh>().text = CoinsBackPacks[k];
                            BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
...
//									//Debug.Log("Ranac sa indeksom "+k+" je novi element posto je "+k+">"+StariBrojOtkljucanihRanceva+" i "+k+"<"+BrojOtkljucanihRanceva);
                                ...
                                BackPacksObjects[k].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                                    LanguageManager.New;
                                BackPacksObjects[k].Find("Bedz - Popust/Text/Number/Number Shadow")
                                    .GetComponent<TextMesh>().text = LanguageManager.New;
                            }
                            else
                            {
//									//Debug.Log("Ranac sa indeksom "+k+" nije novi element");
                        ...
                        else
                        {
                            BackPacksObjects[k].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                                "-" + PopustBackPacks[k] + "%";
                            BackPacksObjects[k].Find("Bedz - Popust/Text/Number/Number Shadow").GetComponent<TextMesh>()
                                .text = PopustBackPacks[k] + "%";
...
//									//Debug.Log("Ranac sa indeksom "+k+" je novi element posto je "+k+">"+StariBrojOtkljucanihRanceva+" i "+k+"<"+BrojOtkljucanihRanceva );
                                ...
                                if (ZakljucaniBackPacks[k] == 1)
                                {
                                    ...
                                    BackPacksObjects[k]
                                        .Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number")
                                        .GetComponent<TextMesh>().text = CoinsBackPacks[k].ToString();
                                    ...
                                    float cena = float.Parse(CoinsBackPacks[k]) -
                                                 float.Parse(CoinsBackPacks[k]) * float.Parse(popust);
...
//									//Debug.Log("Ranac sa indeksom "+k+" nije novi element");
                                if (ZakljucaniBackPacks[k] == 1)
                                {
                                    ...
                                    BackPacksObjects[k].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>()
                                        .text = "-" + PopustBackPacks[k] + "%";
                                    BackPacksObjects[k].Find("Bedz - Popust/Text/Number/Number Shadow")
                                        .GetComponent<TextMesh>().text = PopustBackPacks[k] + "%";
...
//						//Debug.Log("Ime itema broj "+k+" je :"+ImenaBackPacks[k]);
            ...
            for (int i = 0; i < 3; i++)
            {
                if (xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + i)
                        .Attribute("kategorija").Value == "PowerUps")
                {
//						//Debug.Log("Usao u PowerUPs");
                    ImenaPowerUps.Add((string) xmls
                        .ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + i).Value);
                    CoinsPowerUps.Add((string) xmls
                        .ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + i)
                        .Attribute("coins").Value);
                    PopustPowerUps.Add((string) xmls
                        .ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + i)
                        .Attribute("popust").Value);
                    ...
                    {
                        PowerUpsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                            .GetComponent<TextMesh>().text = CoinsPowerUps[i];
                        PowerUpsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                            .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                    ...
                    {
                        PowerUpsObjects[i].Find("Popust/Text/Number").GetComponent<TextMesh>().text =
                            "-" + PopustPowerUps[i] + "%";
                        PowerUpsObjects[i].Find("Popust/Text/Number/Number Shadow").GetComponent<TextMesh>().text =
                            PopustPowerUps[i] + "%";


                        string popust = "0." + PopustPowerUps[i];
                        float cena = float.Parse(CoinsPowerUps[i]) -
                                     float.Parse(CoinsPowerUps[i]) * float.Parse(popust);
...
//						//Debug.Log("Ime itema broj "+i+" je :"+ImenaHats[i]+" coini: "+CoinsHats[i]+" banana: "+BananaHats[i]);
            ...
            if (xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + 3)
                    .Attribute("kategorija").Value == "Banana")
            {
                ImeBanana = (string) xmls.ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + 3)
                    .Value;
                cenaBanana = (string) xmls
                    .ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + 3).Attribute("coins")
                    .Value;
                PopustBanana = (string) xmls
                    .ElementAt(BrojItemaShopHats + BrojItemaShopShirts + BrojItemaShopBackPack + 3).Attribute("popust")
                    .Value;
                ...
                {
                    ShopBanana.transform.Find("Popust").gameObject.SetActive(true);
                    ShopBanana.transform.Find("Polje za unos COINA U shopu - Shop/Coins Number")
                        .GetComponent<TextMesh>().color = PopustBoja;
                    ShopBanana.transform.Find("Popust/Text/Number").GetComponent<TextMesh>().text =
                        PopustBanana + "%";
                    ShopBanana.transform.Find("Popust/Text/Number/Number Shadow").GetComponent<TextMesh>().text =
                        PopustBanana + "%";
                }
                else
                {
                    ShopBanana.transform.Find("Popust").gameObject.SetActive(false);
                }

                ShopBanana.transform.Find("Polje za unos COINA U shopu - Shop/Coins Number")
                    .GetComponent<TextMesh>().text = cenaBanana;
                ShopBanana.transform.Find("Polje za unos COINA U shopu - Shop/Coins Number")
                    .GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);

                ShopBanana.transform.Find("Text/Banana").GetComponent<TextMesh>().text = ImeBanana;
                ShopBanana.transform.Find("Text/Banana").GetComponent<TextMeshEffects>()
...
//				}
            ...
            if (ImaNovihKapa | ImaNovihMajica | ImaNovihRanceva)
            {
                ...
                Custumization.GetComponent<Animation>()
                    .PlayQueued("Button Customization Idle", QueueMode.CompleteOthers);
            }
            else
            {
                Custumization.transform.Find("Znak Uzvika telo").gameObject.SetActive(false);
...
//			//Debug.Log("SveStvariZaOblacenjeBackPack "+j+" je : "+SveStvariZaOblacenjeBackPack[j]);
    ...
    public void SkloniShop()
    {
        if (Application.loadedLevel == 1)
        {
            ...
            if (AktivanRanac == 0)
                MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + AktivanRanac).transform.GetChild(0)
                        .GetComponent<MeshFilter>().mesh =
                    GameObject.Find("RefZaSedenje_AndjeoskaKrila").GetComponent<MeshFilter>().mesh;
            else if (AktivanRanac == 5)
                MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + AktivanRanac).transform.GetChild(0)
                        .GetComponent<MeshFilter>().mesh =
                    GameObject.Find("RefZaSedenje_SlepiMisKrila").GetComponent<MeshFilter>().mesh;
        }
...
//		AktivanCustomizationTab = 0;
        ...
        {
            //Debug.Log("Sacuvaj!!!!!!!!!!");
            StariBrojOtkljucanihItema =
                BrojOtkljucanihKapa + "#" + BrojOtkljucanihMajici + "#" + BrojOtkljucanihRanceva;
            PlayerPrefs.SetString("OtkljucaniItemi", StariBrojOtkljucanihItema);
            PlayerPrefs.Save();
        }
        ...
        if (AktivanTab == 1)
        {
            GameObject.Find("ButtonFreeCoins").GetComponent<SpriteRenderer>().sprite =
                GameObject.Find("ShopTab").GetComponent<SpriteRenderer>().sprite;
        }
        else if (AktivanTab == 2)
        {
            GameObject.Find("ButtonShop").GetComponent<SpriteRenderer>().sprite =
                GameObject.Find("ShopTab").GetComponent<SpriteRenderer>().sprite;
        }
        else if (AktivanTab == 3)
        {
            GameObject.Find("ButtonCustomize").GetComponent<SpriteRenderer>().sprite =
                GameObject.Find("ShopTab").GetComponent<SpriteRenderer>().sprite;
        }
        else if (AktivanTab == 4)
        {
            GameObject.Find("ButtonPowerUps").GetComponent<SpriteRenderer>().sprite =
                GameObject.Find("ShopTab").GetComponent<SpriteRenderer>().sprite;
        }
    ...
    public void PozoviTab(int RedniBrojTaba)
    {
        if (mozeDaOtvoriSledeciTab && kliknuoJednomNaTab)
        {
            ...
            CoinsNumber.transform.Find("Coins Number").GetComponent<TextMesh>().text =
...
//				AktivanCustomizationTab=1;
                ...
                if (AktivanTab == 1)
                {
                    ...
                    {
                        ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCBILikePage")
                            .GetComponent<Collider>().enabled = false;
                        ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCBILikePage")
                            .GetComponent<Renderer>().material.color = new Color(0.58f, 0.58f, 0.58f);
                        ShopManagerFull.ShopObject.transform
                            .Find("1 Free Coins/Free Coins Tabovi/ShopFCBILikePage/Like BananaIsland FC")
                            .GetComponent<Renderer>().material.color = new Color(0.58f, 0.58f, 0.58f);
                    }

                    if (PlayerPrefs.HasKey("LikeWebelinx"))
                    {
                        ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCWLLikePage")
                            .GetComponent<Collider>().enabled = false;
                        ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCWLLikePage")
                            .GetComponent<Renderer>().material.color = new Color(0.58f, 0.58f, 0.58f);
                        ShopManagerFull.ShopObject.transform
                            .Find("1 Free Coins/Free Coins Tabovi/ShopFCWLLikePage/Like Webelinx FC")
                            .GetComponent<Renderer>().material.color = new Color(0.58f, 0.58f, 0.58f);
                    }

                    GameObject.Find("ButtonFreeCoins").GetComponent<SpriteRenderer>().sprite =
                        GameObject.Find("ShopTabSelected").GetComponent<SpriteRenderer>().sprite;
    ...
    public IEnumerator CustomizationTab(int RedniBrojCustomizationTaba1)
    {
        ...
        if (AktivanCustomizationTab != RedniBrojCustomizationTaba1)
        {
            ...
            if (AktivanCustomizationTab == 1)
            {
                ...
                while (t < 0.3f)
                {
                    MajmunBobo.transform.Find("PrinceGorilla").rotation =
                        Quaternion.Lerp(MajmunBobo.transform.Find("PrinceGorilla").rotation, a, t);
                    t += Time.deltaTime / 2;
                    yield return null;
                }
            }
            ...
            if (TrenutniItem < SveStvariZaOblacenjeHats.Count)
            {
                ...
                else
                {
                    ...
                    if (ZakljucaniHats[TrenutniSelektovanSesir] == 1)
                    {
                        ...
                        {
                            ButtonShopSprite.GetComponent<SpriteRenderer>().color =
                                new Color(0.41176f, 0.41176f, 0.41176f);
                            BuyButtonState = 1;
                        }
                        else
                        {
    ...
    public void ProveriStanjeCelogShopa()
    {
        for (int i = 0; i < BrojItemaShopHats; i++)
        {
            ...
            else
            {
                if (PopustHats[i] == "0")
                {
                    HatsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number").GetComponent<TextMesh>()
                        .text = CoinsHats[i];
                    HatsObjects[i].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                        .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                    if (i > StariBrojOtkljucanihKapa & i <= BrojOtkljucanihKapa)
                    {
                        ...
                        HatsObjects[i].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                            LanguageManager.New;
                        HatsObjects[i].Find("Bedz - Popust/Text/Number/Number Shadow").GetComponent<TextMesh>().text =
                            LanguageManager.New;
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (ZakljucaniHats[i] == 1)
                    {
                        ...
                        HatsObjects[i].Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number")
                            .GetComponent<TextMesh>().text = staraCena.ToString();
...
//						CoinsHats[i]=cena.ToString();
        ...
        for (int j = 0; j < BrojItemaShopShirts; j++)
        {
            ...
            else
            {
                if (PopustShirts[j] == "0")
                {
                    ShirtsObjects[j].Find("Polje za unos COINA U shopu - Shop/Coins Number").GetComponent<TextMesh>()
                        .text = CoinsShirts[j];
                    ShirtsObjects[j].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                        .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                    if (j > StariBrojOtkljucanihMajici & j <= BrojOtkljucanihMajici)
                    {
                        ...
                        ShirtsObjects[j].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                            LanguageManager.New;
                        ShirtsObjects[j].Find("Bedz - Popust/Text/Number/Number Shadow").GetComponent<TextMesh>().text =
                            LanguageManager.New;
                    }
                    else
                    {
...
//						CoinsShirts[j]=cena.ToString();
        ...
        for (int k = 0; k < BrojItemaShopBackPack; k++)
        {
            ...
            else
            {
                if (PopustBackPacks[k] == "0")
                {
                    BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop/Coins Number").GetComponent<TextMesh>()
                        .text = CoinsBackPacks[k];
                    BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop/Coins Number")
                        .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                    if (k > StariBrojOtkljucanihRanceva & k <= BrojOtkljucanihRanceva)
                    {
                ...
                else
                {
                    BackPacksObjects[k].Find("Bedz - Popust/Text/Number").GetComponent<TextMesh>().text =
                        "-" + PopustBackPacks[k] + "%";
                    BackPacksObjects[k].Find("Bedz - Popust/Text/Number/Number Shadow").GetComponent<TextMesh>().text =
                        PopustBackPacks[k] + "%";
                    ...
                    if (ZakljucaniBackPacks[k] == 1)
                    {
                        ...
                        BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                            .SetActive(true);
                        BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number")
                            .GetComponent<TextMesh>().text = staraCena.ToString();
                        if (BackPacksObjects[k].parent.gameObject.activeSelf)
                            BackPacksObjects[k].Find("Polje za unos COINA U shopu - Shop_NoDiscount/Coins Number")
                                .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
    ...
    public void KupiItem()
    {
        if (BuyButtonState == 0)
        {
            ...
            if (AktivanCustomizationTab == 1)
            {
                ...
                HatsObjects[AktivanItemSesir].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                    .SetActive(false);
                ...
                for (int i = 0; i < SveStvariZaOblacenjeHats.Count; i++)
                {
                    ...
                    FacebookManager.UserSveKupovineHats = string.Concat(FacebookManager.UserSveKupovineHats,
                        SveStvariZaOblacenjeHats[i] + "#");
                }
            ...
            else if (AktivanCustomizationTab == 2)
            {
                ...
                ShirtsObjects[AktivanItemMajica].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                    .SetActive(false);
                ...
                for (int i = 0; i < SveStvariZaOblacenjeShirts.Count; i++)
                {
                    ...
                    FacebookManager.UserSveKupovineShirts = string.Concat(FacebookManager.UserSveKupovineShirts,
                        SveStvariZaOblacenjeShirts[i] + "#");
                }
            ...
            if (AktivanCustomizationTab == 3)
            {
                ...
                BackPacksObjects[AktivanItemRanac].Find("Polje za unos COINA U shopu - Shop").gameObject
                    .SetActive(false);
                BackPacksObjects[AktivanItemRanac].Find("Polje za unos COINA U shopu - Shop_NoDiscount").gameObject
                    .SetActive(false);
                ...
                {
                    //Debug.Log(SveStvariZaOblacenjeShirts[i]);
                    FacebookManager.UserSveKupovineBackPacks = string.Concat(FacebookManager.UserSveKupovineBackPacks,
                        SveStvariZaOblacenjeBackPack[i] + "#");
                }
        ...
        else if (BuyButtonState == 2)
        {
            ...
            if (AktivanCustomizationTab == 1)
            {
                if (PreviewSesir != -1)
                {
                    MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/Chest/Neck/Head/" + PreviewSesir).transform
                ...
                if (AktivanSesir != -1)
                {
                    MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/Chest/Neck/Head/" + AktivanSesir).transform
                        .GetChild(0).gameObject.SetActive(false);
                }

                MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/Chest/Neck/Head/" + AktivanItemSesir).transform
            ...
            else if (AktivanCustomizationTab == 2)
            {
                ...
                MajmunBobo.transform.Find("PrinceGorilla/custom_Majica").GetComponent<Renderer>().material
                    .SetTexture("_MainTex", MajicaTekstura);
                MajmunBobo.transform.Find("PrinceGorilla/custom_Majica").GetComponent<Renderer>().material.color =
                    TShirtColors[AktivanItemMajica];
...
//				}
                if (PreviewRanac != -1)
                {
                    MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + PreviewRanac).transform.GetChild(0)
                ...
                MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + AktivanItemRanac).transform.GetChild(0)
    ...
    public void KupiDoubleCoins()
    {
        ...
        else
        {
            ...
            GameObject.Find("Double Coins Number/Number").GetComponent<TextMesh>().text =
                StagesParser.powerup_doublecoins.ToString();
            GameObject.Find("Double Coins Number/Number").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(true, true);
    ...
    public void KupiMagnet()
    {
        ...
        else
        {
            ...
            CoinsNumber.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                StagesParser.currentMoney.ToString();
            CoinsNumber.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
            GameObject.Find("Magnet Number/Number").GetComponent<TextMesh>().text =
    ...
    public void KupiShield()
    {
        ...
        else
        {
            ...
            CoinsNumber.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                StagesParser.currentMoney.ToString();
            CoinsNumber.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
            GameObject.Find("Shield Number/Number").GetComponent<TextMesh>().text =
    ...
    public void KupiBananu()
    {
        ...
        else
        {
            ...
            GameObject.Find("Shop/2 Shop - BANANA/Zid Shop/Zid Header i Footer/Zid Footer Shop/Banana Number")
                .GetComponent<Animation>().Play("BoughtPowerUp");
            CoinsNumber.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                StagesParser.currentMoney.ToString();
            CoinsNumber.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
            GameObject.Find("Shop/2 Shop - BANANA/Zid Shop/Zid Header i Footer/Zid Footer Shop/Banana Number/Number")
    ...
    public void OcistiPreview()
    {
        ...
        if (PreviewRanac != -1)
        {
            MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + PreviewRanac).transform.GetChild(0).gameObject
                .SetActive(false);
            PreviewRanac = -1;
        }
...
//			AktivnaMajica=-1;
        ...
        if (AktivanRanac != -1)
        {
            MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + AktivanRanac).transform.GetChild(0).gameObject
                .SetActive(true);
//			AktivanRanac=-1;
            TrenutnoSelektovanRanac = -1;
            ProveraTrenutnogItema(AktivanItemRanac);
    ...
    public void ObuciMajmunaNaStartu()
    {
        ...
        if (AktivanRanac != -1)
        {
            if (Application.loadedLevel == 1)
            {
                if (AktivanRanac == 0)
                    MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + AktivanRanac).transform.GetChild(0)
                        .GetComponent<MeshFilter>().mesh = GameObject.Find("RefZaSedenje_AndjeoskaKrila")
                        .GetComponent<MeshFilter>().mesh;
                else if (AktivanRanac == 5)
                    MajmunBobo.transform.Find("PrinceGorilla/ROOT/Hip/Spine/" + AktivanRanac).transform.GetChild(0)
                        .GetComponent<MeshFilter>().mesh = GameObject.Find("RefZaSedenje_SlepiMisKrila")
                        .GetComponent<MeshFilter>().mesh;
            }
