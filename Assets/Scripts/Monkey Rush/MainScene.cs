...
public class MainScene : MonoBehaviour {
	...
	void Start () {
		...
		if(!PlayerPrefs.HasKey("VecPokrenuto"))
		{
			...
			GameObject.Find("Zastava").collider.enabled = false;
		}
	...
	IEnumerator checkConnectionForLogout()
	{
		...
		if(CheckInternetConnection.Instance.internetOK)
		{
			...
			SettingsObjects[5].collider.enabled = false;
	...
	//					GameObject.Find("ButtonSound").GetComponent<SpriteRenderer>().sprite = GameObject.Find("dugmeSoundOffSprite").GetComponent<SpriteRenderer>().sprite;
				...
				else if(clickedItem==releasedItem && releasedItem == "ButtonCollect")
				{
					...
					case 1:
						...
						GameObject.Find("Day 1").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles").particleSystem.Play();
						GameObject.Find("Day 1").collider.enabled = false;
						GameObject.Find("ButtonCollect").collider.enabled = false;
						//GameObject temp0 = GameObject.Find("CoinsReward");
						//temp0.transform.Find("Coins Number").GetComponent<TextMesh>().text = StagesParser.currentMoney.ToString();
						//temp0.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(false,true);
						temp0.animation.Play("CoinsRewardDolazak");
					...
					case 2:
						...
						GameObject.Find("Day 2").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles").particleSystem.Play();
						GameObject.Find("Day 2").collider.enabled = false;
						GameObject.Find("ButtonCollect").collider.enabled = false;
						//GameObject temp1 = GameObject.Find("CoinsReward");
						//temp1.transform.Find("Coins Number").GetComponent<TextMesh>().text = StagesParser.currentMoney.ToString();
						//temp1.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(false,true);
						temp1.animation.Play("CoinsRewardDolazak");
						Invoke("DelayZaOdbrojavanje",1.15f);
						break;
					case 3:
						...
						GameObject.Find("Day 3").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles").particleSystem.Play();
						GameObject.Find("Day 3").collider.enabled = false;
						GameObject.Find("ButtonCollect").collider.enabled = false;
						//GameObject temp2 = GameObject.Find("CoinsReward");
						//temp2.transform.Find("Coins Number").GetComponent<TextMesh>().text = StagesParser.currentMoney.ToString();
						//temp2.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(false,true);
						temp2.animation.Play("CoinsRewardDolazak");
						Invoke("DelayZaOdbrojavanje",1.15f);
						break;
					case 4:
						...
						GameObject.Find("Day 4").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles").particleSystem.Play();
						GameObject.Find("Day 4").collider.enabled = false;
						GameObject.Find("ButtonCollect").collider.enabled = false;
						//GameObject temp3 = GameObject.Find("CoinsReward");
						//temp3.transform.Find("Coins Number").GetComponent<TextMesh>().text = StagesParser.currentMoney.ToString();
						//temp3.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(false,true);
						temp3.animation.Play("CoinsRewardDolazak");
						Invoke("DelayZaOdbrojavanje",1.15f);
						break;
					case 5:
						...
						GameObject.Find("Day 5").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles").particleSystem.Play();
						GameObject.Find("Day 5").collider.enabled = false;
						GameObject.Find("ButtonCollect").collider.enabled = false;
						//GameObject temp4 = GameObject.Find("CoinsReward");
						//temp4.transform.Find("Coins Number").GetComponent<TextMesh>().text = StagesParser.currentMoney.ToString();
						//temp4.transform.Find("Coins Number").GetComponent<TextMeshEffects>().RefreshTextOutline(false,true);
						temp4.animation.Play("CoinsRewardDolazak");
						Invoke("DelayZaOdbrojavanje",1.15f);
						break;
					case 6:
						...
						//Invoke("DelayZaOdbrojavanje",1.15f);
						GameObject.Find("Day 6 - Magic Box").collider.enabled = false;
						GameObject.Find("ButtonCollect").collider.enabled = false;
						MysteryBox();
						break;
					}
				...
				else if(clickedItem==releasedItem && releasedItem == "Kovceg")
				{
					...
					temp1.transform.Find("PARTIKLI za Kada Se Klikne Collect/CFXM3 Spikes").particleSystem.Play();
					temp1.transform.Find("PARTIKLI za Kada Se Klikne Collect/CollectCoinsParticles").particleSystem.Play();
				...
				else if(clickedItem==releasedItem && releasedItem == "4 Reset Progres")
				{
					...
					SettingsObjects[3].collider.enabled = false;
				...
				else if(clickedItem==releasedItem && releasedItem == "5 Reset Tutorials")
				{
					...
					SettingsObjects[4].collider.enabled = false;
...
//	}
	...
	public void PrikaziSettings()
	{
		if(FB.IsLoggedIn)
		{
			SettingsObjects[5].collider.enabled = true;
	...
	public void PromeniZastavuNaOsnovuImena()
	{
		...
		if(StagesParser.jezikPromenjen != 0 || (GameObject.FindGameObjectWithTag("Zastava").renderer.material.mainTexture.name.Equals("0") && !LanguageManager.chosenLanguage.Equals("_en")))
		{
			switch(LanguageManager.chosenLanguage)
			{
			case "_en":
	...
	public void PromeniZastavu(int BrojZastave)
	{
		...
		GameObject.FindGameObjectWithTag("Zastava").renderer.material.SetTexture("_MainTex", Zastava);
		if(PlayerPrefs.HasKey("JezikPromenjen"))
			GameObject.Find("Settings i Language Scena").transform.Find("Language Tabs/"+BrojZastave.ToString()+"/Shop Tab Element Selected").renderer.enabled = true;
		if(selectedLanguage != 0 && selectedLanguage != BrojZastave)
		{
			GameObject.Find("Settings i Language Scena").transform.Find("Language Tabs/"+selectedLanguage.ToString()+"/Shop Tab Element Selected").renderer.enabled = false;
		}
