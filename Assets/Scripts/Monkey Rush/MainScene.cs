...
{
    [FormerlySerializedAs("FriendsObjects")]
    public Transform[] friendsObjects = new Transform[0];

    [FormerlySerializedAs("SettingsObjects")]
    public Transform[] settingsObjects = new Transform[0];

    [FormerlySerializedAs("LanguagesObjects")]
    ...
    GameObject temp;
    System.Globalization.DateTimeFormatInfo _format;
    ...
    void Start()
    {
        ...
        LeaderBoardInvite.transform.Find("Text/Number").GetComponent<TextMeshEffects>()
        ...
        GameObject.Find("Gore Levo HOLDER Buttons").transform.position = new Vector3(
            Camera.main.ViewportToWorldPoint(Vector3.zero).x, Camera.main.ViewportToWorldPoint(Vector3.one).y, 0);
        GameObject.Find("Dole Desno HOLDER Buttons").transform.position = new Vector3(
            Camera.main.ViewportToWorldPoint(Vector3.one).x, Camera.main.ViewportToWorldPoint(Vector3.zero).y, 0);
        GameObject.Find("Dole Levo HOLDER Buttons").transform.position = new Vector3(
            Camera.main.ViewportToWorldPoint(Vector3.zero).x, Camera.main.ViewportToWorldPoint(Vector3.zero).y, 0);
        ...
        {
            settingsObjects[2].Find("Shop Tab Element Selected").GetComponent<SpriteRenderer>().enabled = false;
        }
        else
        {
            settingsObjects[2].Find("Shop Tab Element Selected").GetComponent<SpriteRenderer>().enabled = true;
        }

        if (PlaySounds.musicOn)
        {
            settingsObjects[1].Find("Shop Tab Element Selected").GetComponent<SpriteRenderer>().enabled = false;
            PlaySounds.Play_BackgroundMusic_Menu();
        }
        else
        {
            settingsObjects[1].Find("Shop Tab Element Selected").GetComponent<SpriteRenderer>().enabled = true;
        }
        ...
        else
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                if (i == 1)
                {
                    friendsObjects[i].Find("FB Invite").gameObject.SetActive(true);
                    friendsObjects[i].Find("Friend").gameObject.SetActive(false);
                    friendsObjects[i].Find("FB Invite/Coin Shop").gameObject.SetActive(false);
                    friendsObjects[i].Find("FB Invite/Invite").GetComponent<TextMesh>().text =
                        LanguageManager.LogIn;
                    friendsObjects[i].Find("FB Invite/Invite").GetComponent<TextMeshEffects>()
                        .RefreshTextOutline(true, true);
                    friendsObjects[i].Find("FB Invite/Coin Number").GetComponent<TextMesh>().text =
                        "+" + StagesParser.LoginReward;
                    friendsObjects[i].Find("FB Invite/Coin Number").GetComponent<TextMeshEffects>()
                        .RefreshTextOutline(false, false);
                }
                else
                {
    ...
    IEnumerator checkConnectionForLogout()
    {
        ...
        if (CheckInternetConnection.Instance.internetOK)
        {
            ...
            if (FB.IsLoggedIn)
            {
                ...
                FacebookManager.FacebookObject.SacuvajScoreNaNivoima(StagesParser.PointsPoNivoima,
                    StagesParser.StarsPoNivoima, StagesParser.maxLevel, StagesParser.bonusLevels);
                FacebookManager.FacebookObject.UpdateujPodatkeKorisnika(StagesParser.currentMoney,
                    StagesParser.currentPoints, LanguageManager.chosenLanguage, StagesParser.currentBananas,
                    StagesParser.powerup_magnets, StagesParser.powerup_shields, StagesParser.powerup_doublecoins,
                    StagesParser.svekupovineGlava, StagesParser.svekupovineMajica, StagesParser.svekupovineLedja,
                    StagesParser.ledja, StagesParser.glava, StagesParser.majica, StagesParser.imaUsi,
                    StagesParser.imaKosu, FacebookManager.NumberOfFriends);
            }
            ...
            leaderboardLogin.localPosition =
                new Vector3(leaderboardLogin.localPosition.x, -1.85f, leaderboardLogin.localPosition.z);
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (clickedItem.Equals("NekoDugme") || clickedItem.Equals("ButtonSettings") ||
                clickedItem.Equals("ButtonLeaderboard") || clickedItem.Equals("Custumization") ||
                clickedItem.Equals("FreeCoins")
                || clickedItem.Equals("4 Reset Progres") || clickedItem.Equals("5 Reset Tutorials") ||
                clickedItem.Equals("6 Log Out") || clickedItem.Equals("Button_CheckOK"))
            {
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            if (!clickedItem.Equals(System.String.Empty))
            {
                ...
                if (clickedItem == releasedItem && releasedItem == "Play")
                {
                    if (PlaySounds.soundOn)
                        PlaySounds.Play_Button_OpenLevel();
                    _format = System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat;
                    string VremeQuitString = System.DateTime.Now.ToString(_format.FullDateTimePattern);
                ...
                else if (clickedItem == releasedItem && releasedItem == "FreeCoins")
                {
                    ...
                    if (ShopManagerFull.AktivanRanac == 0)
                        GameObject.Find("MonkeyHolder").transform
                            .Find("PrinceGorilla/ROOT/Hip/Spine/" + ShopManagerFull.AktivanRanac).transform.GetChild(0)
                            .GetComponent<MeshFilter>().mesh = GameObject.Find("RefZaShop_AndjeoskaKrila")
                            .GetComponent<MeshFilter>().mesh;
                    else if (ShopManagerFull.AktivanRanac == 5)
                        GameObject.Find("MonkeyHolder").transform
                            .Find("PrinceGorilla/ROOT/Hip/Spine/" + ShopManagerFull.AktivanRanac).transform.GetChild(0)
                            .GetComponent<MeshFilter>().mesh = GameObject.Find("RefZaShop_SlepiMisKrila")
                            .GetComponent<MeshFilter>().mesh;
                ...
                else if (clickedItem == releasedItem && releasedItem == "BackButtonSettings")
                {
                    ...
                    {
                        SettingState = 1;
                        GameObject.Find("Settings i Language Scena/Settings Tabs").GetComponent<Animation>()
                            .Play("TabSettingsDolazak");
                        GameObject.Find("Settings i Language Scena/Language Tabs").GetComponent<Animation>()
                            .Play("TabSettingsOdlazak");
                        AktivirajSettings();
                        if (LanguageManager.chosenLanguage != jezikPreUlaskaUPromenuJezika)
                        {
                            jezikPreUlaskaUPromenuJezika = LanguageManager.chosenLanguage;
                ...
                else if (clickedItem == releasedItem && releasedItem == "ButtonCollect")
                {
                    ...
                    switch (DailyRewards.LevelReward)
                    {
                        case 1:
                            ...
                            temp0.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                                StagesParser.currentMoney.ToString();
                            temp0.transform.Find("Coins Number").GetComponent<TextMeshEffects>()
                            ...
                            GameObject.Find("Day 1").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles")
                        ...
                        case 2:
                            ...
                            temp1.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                                StagesParser.currentMoney.ToString();
                            temp1.transform.Find("Coins Number").GetComponent<TextMeshEffects>()
                                .RefreshTextOutline(false, true);
                            StagesParser.currentMoney += DailyRewards.DailyRewardAmount[1];
                            PlayerPrefs.SetInt("TotalMoney", StagesParser.currentMoney);
                            PlayerPrefs.Save();
                            dailyReward = DailyRewards.DailyRewardAmount[1];
                            GameObject.Find("Day 2").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles")
                                .GetComponent<ParticleSystem>().Play();
                        ...
                        case 3:
                            ...
                            temp2.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                                StagesParser.currentMoney.ToString();
                            temp2.transform.Find("Coins Number").GetComponent<TextMeshEffects>()
                                .RefreshTextOutline(false, true);
                            StagesParser.currentMoney += DailyRewards.DailyRewardAmount[2];
                            PlayerPrefs.SetInt("TotalMoney", StagesParser.currentMoney);
                            PlayerPrefs.Save();
                            dailyReward = DailyRewards.DailyRewardAmount[2];
                            GameObject.Find("Day 3").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles")
                                .GetComponent<ParticleSystem>().Play();
                        ...
                        case 4:
                            ...
                            temp3.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                                StagesParser.currentMoney.ToString();
                            temp3.transform.Find("Coins Number").GetComponent<TextMeshEffects>()
                                .RefreshTextOutline(false, true);
                            StagesParser.currentMoney += DailyRewards.DailyRewardAmount[3];
                            PlayerPrefs.SetInt("TotalMoney", StagesParser.currentMoney);
                            PlayerPrefs.Save();
                            dailyReward = DailyRewards.DailyRewardAmount[3];
                            GameObject.Find("Day 4").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles")
                                .GetComponent<ParticleSystem>().Play();
                        ...
                        case 5:
                            ...
                            temp4.transform.Find("Coins Number").GetComponent<TextMesh>().text =
                                StagesParser.currentMoney.ToString();
                            temp4.transform.Find("Coins Number").GetComponent<TextMeshEffects>()
                                .RefreshTextOutline(false, true);
                            StagesParser.currentMoney += DailyRewards.DailyRewardAmount[4];
                            PlayerPrefs.SetInt("TotalMoney", StagesParser.currentMoney);
                            PlayerPrefs.Save();
                            dailyReward = DailyRewards.DailyRewardAmount[4];
                            GameObject.Find("Day 5").transform.GetChild(0).Find("CollectCoinsDailyRewardParticles")
                                .GetComponent<ParticleSystem>().Play();
                ...
                else if (clickedItem == releasedItem && releasedItem == "Kovceg")
                {
                    ...
                    temp1.transform.Find("PARTIKLI za Kada Se Klikne Collect/CFXM3 Spikes")
                        .GetComponent<ParticleSystem>().Play();
                    temp1.transform.Find("PARTIKLI za Kada Se Klikne Collect/CollectCoinsParticles")
                ...
                else if (clickedItem == releasedItem && releasedItem == "2 Music")
                {
                    if (PlaySounds.musicOn)
                    {
                        settingsObjects[1].Find("Shop Tab Element Selected").GetComponent<SpriteRenderer>()
                            .enabled = true;
                        PlaySounds.musicOn = false;
                        PlayerPrefs.SetInt("musicOn", 0);
                        PlayerPrefs.Save();
                ...
                else if (clickedItem == releasedItem && releasedItem == "3 Sound")
                {
                    if (PlaySounds.soundOn)
                    {
                        settingsObjects[2].Find("Shop Tab Element Selected").GetComponent<SpriteRenderer>()
                            .enabled = true;
                        PlaySounds.soundOn = false;
                        PlayerPrefs.SetInt("soundOn", 0);
                        PlayerPrefs.Save();
                ...
                else if (clickedItem == releasedItem && releasedItem == "Exit Button")
                {
                    ...
                    if (StagesParser.ServerUpdate == 1 && FB.IsLoggedIn)
                    {
                        ...
                        FacebookManager.FacebookObject.UpdateujPodatkeKorisnika(StagesParser.currentMoney,
                            StagesParser.currentPoints, LanguageManager.chosenLanguage, StagesParser.currentBananas,
                            StagesParser.powerup_magnets, StagesParser.powerup_shields,
                            StagesParser.powerup_doublecoins, StagesParser.svekupovineGlava,
                            StagesParser.svekupovineMajica, StagesParser.svekupovineLedja, StagesParser.ledja,
                            StagesParser.glava, StagesParser.majica, StagesParser.imaUsi, StagesParser.imaKosu,
                            FacebookManager.NumberOfFriends);
                    }
...
//	}
    ...
    public void PromeniZastavuNaOsnovuImena()
    {
        ...
        if (StagesParser.jezikPromenjen != 0 ||
            (GameObject.FindGameObjectWithTag("Zastava").GetComponent<Renderer>().material.mainTexture.name
                 .Equals("0") &&
             !LanguageManager.chosenLanguage.Equals("_en")))
        {
            switch (LanguageManager.chosenLanguage)
            {
                case "_en":
            ...
            GameObject.FindGameObjectWithTag("Zastava").GetComponent<Renderer>().material
                .SetTexture("_MainTex", Zastava);
        }
    ...
    public void PromeniZastavu(int BrojZastave)
    {
        ...
        if (PlayerPrefs.HasKey("JezikPromenjen"))
            GameObject.Find("Settings i Language Scena").transform
                .Find("Language Tabs/" + BrojZastave.ToString() + "/Shop Tab Element Selected").GetComponent<Renderer>()
                .enabled = true;
        if (selectedLanguage != 0 && selectedLanguage != BrojZastave)
        {
            GameObject.Find("Settings i Language Scena").transform
                    .Find("Language Tabs/" + selectedLanguage.ToString() + "/Shop Tab Element Selected")
...
//		GameObject.Find ("RestoreText").GetComponent<TextMeshEffects>().RefreshTextOutline(true,true);
        ...
        GameObject.Find("Home Scena Interface").transform.Find("FB HOLDER LogIn/ButtonFacebook/Log in")
            .GetComponent<TextMesh>().text = LanguageManager.LogIn;
        GameObject.Find("Home Scena Interface").transform.Find("FB HOLDER LogIn/ButtonFacebook/Log in")
        ...
        GameObject.Find("ShopFCBILikePage/Text/FollowUsOnFacebook").GetComponent<TextMesh>().text =
            LanguageManager.FollowUsOnFacebook;
        GameObject.Find("ShopFCBILikePage/Text/FollowUsOnFacebook").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);

        GameObject.Find("ShopFCWLLikePage/Text/FollowUsOnFacebook").GetComponent<TextMesh>().text =
            LanguageManager.FollowUsOnFacebook;
        GameObject.Find("ShopFCWLLikePage/Text/FollowUsOnFacebook").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);
...
//		GameObject.Find ("ButtonPreview").GetComponent<TextMeshEffects>().RefreshTextOutline(true,true);
        ...
        GameObject.Find("Leaderboard Scena").transform.Find("FB Invite/Text/Invite And Earn").GetComponent<TextMesh>()
            .text = LanguageManager.InviteAndEarn;
        GameObject.Find("Leaderboard Scena").transform.Find("FB Invite/Text/Invite And Earn")
            .GetComponent<TextMeshEffects>().RefreshTextOutline(true, true);
...
//		GameObject.Find("Friends Tabs").transform.Find("Friend No 2/FB Invite/Invite").GetComponent<TextMeshEffects>().RefreshTextOutline(true,true);
        ...
        GameObject.Find("Day 1/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMesh>().text =
            LanguageManager.Day + " 1";
        GameObject.Find("Day 1/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);

        GameObject.Find("Day 2/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMesh>().text =
            LanguageManager.Day + " 2";
        GameObject.Find("Day 2/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);

        GameObject.Find("Day 3/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMesh>().text =
            LanguageManager.Day + " 3";
        GameObject.Find("Day 3/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);

        GameObject.Find("Day 4/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMesh>().text =
            LanguageManager.Day + " 4";
        GameObject.Find("Day 4/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);

        GameObject.Find("Day 5/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMesh>().text =
            LanguageManager.Day + " 5";
        GameObject.Find("Day 5/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);

        GameObject.Find("Day 6 - Magic Box/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMesh>().text =
            LanguageManager.Day + " 6";
        GameObject.Find("Day 6 - Magic Box/DailyRewordDayAnimationHolder/Text/Day").GetComponent<TextMeshEffects>()
            .RefreshTextOutline(true, true);
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            {
                temp.GetChild(i).Find("FB Invite/Invite").GetComponent<TextMesh>().text =
                    LanguageManager.InviteFriendsAndEarn;
                temp.GetChild(i).Find("FB Invite/Invite").GetComponent<TextMeshEffects>()
                    .RefreshTextOutline(true, true);
            }
            else
            {
    ...
    {
        StartCoroutine(StagesParser.Instance.moneyCounter(dailyReward,
            GameObject.Find("CoinsReward/Coins Number").GetComponent<TextMesh>(), true));
    ...
    void MysteryBox()
    {
        ...
        if (StagesParser.powerup_magnets <= StagesParser.powerup_shields)
        {
            ...
            {
                powerUpRewardSprite = ShopManagerFull.ShopObject.transform
                    .Find("4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Magnet/Plavi Bedz/Magnet Icon")
                    .GetComponent<SpriteRenderer>().sprite;
                if (StagesParser.powerup_magnets <= 10)
                {
                    StagesParser.powerup_magnets += 3;
                    temp1.transform.GetChild(0).Find("Magic Box Reward HOLDER/Magic Box Reward/Kolicina")
                        .GetComponent<TextMesh>().text = "x 3";
                    temp1.transform.GetChild(0).Find("Magic Box Reward HOLDER/Magic Box Reward/Kolicina")
                ...
                else
                {
                    ...
                    temp1.transform.GetChild(0).Find("Magic Box Reward HOLDER/Magic Box Reward/Kolicina")
                        .GetComponent<TextMesh>().text = "x 2";
                    temp1.transform.GetChild(0).Find("Magic Box Reward HOLDER/Magic Box Reward/Kolicina")
                        .GetComponent<TextMeshEffects>().RefreshTextOutline(false, true);
                }
            }
            ...
            {
                powerUpRewardSprite = ShopManagerFull.ShopObject.transform
                    .Find("4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Double Coins/Plavi Bedz/Double Coins Icon")
                    .GetComponent<SpriteRenderer>().sprite;
        ...
        {
            powerUpRewardSprite = ShopManagerFull.ShopObject.transform
                .Find("4 Power-Ups/Power-Ups Tabovi/Shop POWERUP Shield/Plavi Bedz/Shield Icon")
                .GetComponent<SpriteRenderer>().sprite;
        ...
        temp1.transform.GetChild(0).Find("Magic Box Reward HOLDER/Magic Box Reward").GetComponent<SpriteRenderer>()
            .sprite = powerUpRewardSprite;
