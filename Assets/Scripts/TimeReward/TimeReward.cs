...
//		PlayerPrefs.DeleteAll();
        ...
        if (PlayerPrefs.HasKey("VremeBrojaca"))
        {
            ...
            if (VremeBrojaca < 1)
            {
                ...
                Kovceg.GetComponent<Animator>().Play("Kovceg Collect GetComponent<Animation>()");
            }
            else
            {
...
//				Kovceg.GetComponent<TextMesh>().text= VremeBrojaca.ToString("F0");
        ...
        else if (Sati > 0)
        {
            if (Sekunde >= 0 && Sekunde <= 9)
            {
                if (Minuti < 10)
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text = "0" + Sati.ToString() + ":0" +
                        Minuti.ToString() + ":" + "0" + Sekunde.ToString();
                }
                else
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text = "0" + Sati.ToString() + ":" +
                        Minuti.ToString() + ":" + "0" + Sekunde.ToString();
                }
            }
            else
            {
                ...
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text = "0" + Sati.ToString() + ":0" +
                        Minuti.ToString() + ":" + Sekunde.ToString();
                }
                else
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text = "0" + Sati.ToString() + ":" +
        ...
        else
        {
            if (Sekunde >= 0 && Sekunde <= 9)
            {
                if (Minuti < 10)
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text =
                        "00:0" + Minuti.ToString() + ":" + "0" + Sekunde.ToString();
                }
                else
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text =
                        "00:" + Minuti.ToString() + ":" + "0" + Sekunde.ToString();
                }
            }
            else
            {
                ...
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text =
                        "00:0" + Minuti.ToString() + ":" + Sekunde.ToString();
                }
                else
                {
                    Kovceg.transform.Find("Text/Collect").GetComponent<TextMesh>().text =
                        "00:" + Minuti.ToString() + ":" + Sekunde.ToString();
                }
            }
        }
    ...
    {
        //vraca false kad je aktivna app
        if (pauseStatus)
        {
...
//					Kovceg.transform.Find("Novcici").gameObject.SetActive(false);
    ...
    {
        StartCoroutine(StagesParser.Instance.moneyCounter(100,
