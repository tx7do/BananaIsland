...
//			Application.OpenURL("https://www.facebook.com/pages/Banana-Island/636650059721490");
	...
	void OnApplicationPause(bool pauseStatus)
	{
		if(!pauseStatus) //odpauzirana
		{
			...
			if(otisaoDaLajkuje)
			{
				...
				if(stranica == "BananaIsland")
				{
					ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCBILikePage").collider.enabled = false;
					ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCBILikePage").renderer.material.color = new Color(0.58f,0.58f,0.58f);
					ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCBILikePage/Like BananaIsland FC").renderer.material.color = new Color(0.58f,0.58f,0.58f);
				...
				{
					ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCWLLikePage").collider.enabled = false;
					ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCWLLikePage").renderer.material.color = new Color(0.58f,0.58f,0.58f);
					ShopManagerFull.ShopObject.transform.Find("1 Free Coins/Free Coins Tabovi/ShopFCWLLikePage/Like Webelinx FC").renderer.material.color = new Color(0.58f,0.58f,0.58f);
					StagesParser.currentMoney += StagesParser.likePageReward;
					PlayerPrefs.SetInt("TotalMoney",StagesParser.currentMoney);
					PlayerPrefs.Save();
					StartCoroutine(StagesParser.Instance.moneyCounter(StagesParser.likePageReward,ShopManagerFull.ShopObject.transform.Find("Shop Interface/Coins/Coins Number").GetComponent<TextMesh>(),true));
	...
	{                                                                                                                              
		...
		else
		{
			...
			GameObject.Find("FaceButton").renderer.material.mainTexture=ProfilePicture; 
		}
...
//		FB.API("me/friends/?fields=installed,name,picture",Facebook.HttpMethod.GET,SviPrijateljiFacebookCallback);
	...
	//				FriendPic1=result.Texture;
					GameObject.Find("Friends Level Win Picture 1").renderer.material.mainTexture=ProfileSlikePrijatelja[0].profilePicture;
					WaitForFacebook=true;
				break;

				case 2:
	//				FriendPic2=result.Texture;
					GameObject.Find("Friends Level Win Picture 2").renderer.material.mainTexture=ProfileSlikePrijatelja[1].profilePicture;
					WaitForFacebook=true;
				break;

				case 3:
	//				FriendPic3=result.Texture;
					GameObject.Find("Friends Level Win Picture 3").renderer.material.mainTexture=ProfileSlikePrijatelja[2].profilePicture;
					WaitForFacebook=true;
				break;
					
				case 4:
	//				FriendPic4=result.Texture;
					GameObject.Find("Friends Level Win Picture 4").renderer.material.mainTexture=ProfileSlikePrijatelja[3].profilePicture;
					WaitForFacebook=true;
				break;
				
				case 5:
	//				FriendPic5=result.Texture;
					GameObject.Find("Friends Level Win Picture 5").renderer.material.mainTexture=ProfileSlikePrijatelja[4].profilePicture;
					WaitForFacebook=true;
				break;

				case 6:
					//				FriendPic5=result.Texture;
					GameObject.Find("Friends Level Win Picture 6").renderer.material.mainTexture=ProfileSlikePrijatelja[5].profilePicture;
					WaitForFacebook=true;
					break;

				case 7:
					//				FriendPic5=result.Texture;
					GameObject.Find("Friends Level Win Picture 7").renderer.material.mainTexture=ProfileSlikePrijatelja[6].profilePicture;
					WaitForFacebook=true;
					break;

				case 8:
					//				FriendPic5=result.Texture;
					GameObject.Find("Friends Level Win Picture 8").renderer.material.mainTexture=ProfileSlikePrijatelja[7].profilePicture;
					WaitForFacebook=true;
					break;

				case 9:
					//				FriendPic5=result.Texture;
					GameObject.Find("Friends Level Win Picture 9").renderer.material.mainTexture=ProfileSlikePrijatelja[8].profilePicture;
					WaitForFacebook=true;
					break;

				case 10:
					//				FriendPic5=result.Texture;
					GameObject.Find("Friends Level Win Picture 10").renderer.material.mainTexture=ProfileSlikePrijatelja[9].profilePicture;
					WaitForFacebook=true;
					break;
		...
		if(FB.IsLoggedIn)
		{
			...
			else
			{
				...
				if(MestoPozivanjaLogina == 1)
				{
					...
					temp.animation.Play("CoinsRewardDolazak");
...
//					}
	...
	{
		GameObject.Find("CoinsReward").animation.Play("CoinsRewardOdlazak");
	}
