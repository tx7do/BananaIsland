...
//		OdrediMisiju(currentLevel);
    ...
    public static void OdrediIkonice(int level)
    {
        ...
        if (activeFly_BaboonsMission)
        {
            ...
            if (missions[level].fly_baboons > 0)
            {
                LevelFactory.instance.leteciBabuni_Kvota = LevelFactory.instance.leteciBabuni_Kvota_locked =
                    7f / missions[level].fly_baboons;
            }
        }
        ...
        if (activeBoomerang_BaboonsMission)
        {
            ...
            if (missions[level].boomerang_baboons > 0)
            {
                LevelFactory.instance.boomerangBabuni_Kvota = LevelFactory.instance.boomerangBabuni_Kvota_locked =
                    7f / missions[level].boomerang_baboons;
            }
        }
        ...
        if (activeFly_GorillaMission)
        {
            ...
            if (missions[level].fly_gorilla > 0)
            {
                LevelFactory.instance.leteceGorile_Kvota = LevelFactory.instance.leteceGorile_Kvota_locked =
                    7f / missions[level].fly_gorilla;
            }
        }
        ...
        if (activeKoplje_GorillaMission)
        {
            ...
            if (missions[level].koplje_gorilla > 0)
            {
                LevelFactory.instance.kopljeGorile_Kvota = LevelFactory.instance.kopljeGorile_Kvota_locked =
                    7f / missions[level].koplje_gorilla;
            }
        }
        ...
        if (activeCoinsMission)
        {
            ...
            textMission.localPosition = new Vector3(0, 0, -0.1f);
            textMission.gameObject.SetActive(true);
            textMission.GetChild(0).Find("Target Number").GetComponent<TextMesh>().text =
                missions[level].coins.ToString();
            textMission.GetChild(0).Find("Target Number").GetComponent<TextMeshEffects>()
        ...
        if (activeDistanceMission)
        {
            ...
            textMission.gameObject.SetActive(true);
            textMission.GetChild(0).Find("Target Number").GetComponent<TextMesh>().text =
                missions[level].distance.ToString();
            textMission.GetChild(0).Find("Target Number").GetComponent<TextMeshEffects>()
                .RefreshTextOutline(false, true);
        ...
        if (activeRedDiamondsMission)
        {
            ...
            if (missions[level].red_diamonds > 0)
            {
                LevelFactory.instance.crveniDijamant_Kvota = LevelFactory.instance.crveniDijamant_Kvota_locked =
                    7f / missions[level].red_diamonds;
            }
        }
        ...
        if (activeBlueDiamondsMission)
        {
            ...
            if (missions[level].blue_diamonds > 0)
            {
                LevelFactory.instance.plaviDijamant_Kvota = LevelFactory.instance.plaviDijamant_Kvota_locked =
                    7f / missions[level].blue_diamonds;
            }
        }
        ...
        if (activeGreenDiamondsMission)
        {
            ...
            if (missions[level].green_diamonds > 0)
            {
                LevelFactory.instance.zeleniDijamant_Kvota = LevelFactory.instance.zeleniDijamant_Kvota_locked =
                    7f / missions[level].green_diamonds;
            }
        }
    ...
    public static void OdrediIkoniceNaMapi(int level)
    {
        ...
        if (activeBaboonsMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                ...
                values = missions[level].IspisiDescriptionNaIspravnomJeziku()
        ...
        if (activeFly_BaboonsMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 =
                    missionPopup.Find("Mission Icons/Mission 1/Babun Leteci").GetComponent<Renderer>();
                aktivnaIkonicaMisija1.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 =
                    missionPopup.Find("Mission Icons/Mission 2/Babun Leteci").GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 =
                    missionPopup.Find("Mission Icons/Mission 3/Babun Leteci").GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
        ...
        if (activeBoomerang_BaboonsMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 =
                    missionPopup.Find("Mission Icons/Mission 1/Babun Bumerang").GetComponent<Renderer>();
                aktivnaIkonicaMisija1.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 =
                    missionPopup.Find("Mission Icons/Mission 2/Babun Bumerang").GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 =
                    missionPopup.Find("Mission Icons/Mission 3/Babun Bumerang").GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
        ...
        if (activeFly_GorillaMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 =
                    missionPopup.Find("Mission Icons/Mission 1/Gorila Leteca").GetComponent<Renderer>();
                aktivnaIkonicaMisija1.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 =
                    missionPopup.Find("Mission Icons/Mission 2/Gorila Leteca").GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 =
                    missionPopup.Find("Mission Icons/Mission 3/Gorila Leteca").GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
        ...
        if (activeKoplje_GorillaMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Gorila Sa Kopljem")
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Gorila Sa Kopljem")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Gorila Sa Kopljem")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
        ...
        if (activeDiamondsMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 =
                    missionPopup.Find("Mission Icons/Mission 1/3 Dijamanta").GetComponent<Renderer>();
                aktivnaIkonicaMisija1.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 =
                    missionPopup.Find("Mission Icons/Mission 2/3 Dijamanta").GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 =
                    missionPopup.Find("Mission Icons/Mission 3/3 Dijamanta").GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
        ...
        if (activeRedDiamondsMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Crveni Dijamant")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija1.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Crveni Dijamant")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Crveni Dijamant")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
        ...
        if (activeBlueDiamondsMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 =
                    missionPopup.Find("Mission Icons/Mission 1/Plavi Dijamant").GetComponent<Renderer>();
                aktivnaIkonicaMisija1.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 =
                    missionPopup.Find("Mission Icons/Mission 2/Plavi Dijamant").GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 =
                    missionPopup.Find("Mission Icons/Mission 3/Plavi Dijamant").GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
        ...
        if (activeGreenDiamondsMission)
        {
            if (tempNumberOfQuestsLeft == 1)
            {
                if (aktivnaIkonicaMisija1 != null)
                    aktivnaIkonicaMisija1.enabled = false;
                aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Zeleni Dijamant")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija1.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 2)
            {
                if (aktivnaIkonicaMisija2 != null)
                    aktivnaIkonicaMisija2.enabled = false;
                aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Zeleni Dijamant")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija2.enabled = true;
            ...
            else if (tempNumberOfQuestsLeft == 3)
            {
                if (aktivnaIkonicaMisija3 != null)
                    aktivnaIkonicaMisija3.enabled = false;
                aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Zeleni Dijamant")
                    .GetComponent<Renderer>();
                aktivnaIkonicaMisija3.enabled = true;
    ...
    public void Boomerang_BaboonEvent(int currentBoomerang_Baboons)
    {
        if (missions[currentLevel].boomerang_baboons > 0)
        {
            ...
            boomerang_baboonsTextEffects.RefreshTextOutline(false, true);
            if (currentBoomerang_Baboons >= missions[currentLevel].boomerang_baboons &&
    ...
    public void Koplje_GorillaEvent(int currentKoplje_Gorillas)
    {
        if (missions[currentLevel].koplje_gorilla > 0)
        {
            ...
            koplje_gorillaTextEffects.RefreshTextOutline(false, true);
            if (currentKoplje_Gorillas >= missions[currentLevel].koplje_gorilla &&
