	...
	public static void OdrediIkoniceNaMapi(int level)
	{
		...
		if(activeBaboonsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				...
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Babun").renderer;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				...
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Babun").renderer;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				...
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Babun").renderer;
		...
		if(activeFly_BaboonsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Babun Leteci").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Babun Leteci").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Babun Leteci").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeBoomerang_BaboonsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Babun Bumerang").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Babun Bumerang").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Babun Bumerang").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeGorillaMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Gorila").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Gorila").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Gorila").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeFly_GorillaMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Gorila Leteca").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Gorila Leteca").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Gorila Leteca").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeKoplje_GorillaMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Gorila Sa Kopljem").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Gorila Sa Kopljem").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Gorila Sa Kopljem").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeDiamondsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/3 Dijamanta").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/3 Dijamanta").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/3 Dijamanta").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeCoinsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Coin").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Coin").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Coin").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeDistanceMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Distance").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Distance").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Distance").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeBarrelsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Bure").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Bure").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Bure").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeRedDiamondsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Crveni Dijamant").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Crveni Dijamant").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Crveni Dijamant").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeBlueDiamondsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Plavi Dijamant").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Plavi Dijamant").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Plavi Dijamant").renderer;
				aktivnaIkonicaMisija3.enabled = true;
		...
		if(activeGreenDiamondsMission)
		{
			if(tempNumberOfQuestsLeft == 1)
			{
				if(aktivnaIkonicaMisija1 != null)
					aktivnaIkonicaMisija1.enabled = false;
				aktivnaIkonicaMisija1 = missionPopup.Find("Mission Icons/Mission 1/Zeleni Dijamant").renderer;
				aktivnaIkonicaMisija1.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 2)
			{
				if(aktivnaIkonicaMisija2 != null)
					aktivnaIkonicaMisija2.enabled = false;
				aktivnaIkonicaMisija2 = missionPopup.Find("Mission Icons/Mission 2/Zeleni Dijamant").renderer;
				aktivnaIkonicaMisija2.enabled = true;
			...
			else if(tempNumberOfQuestsLeft == 3)
			{
				if(aktivnaIkonicaMisija3 != null)
					aktivnaIkonicaMisija3.enabled = false;
				aktivnaIkonicaMisija3 = missionPopup.Find("Mission Icons/Mission 3/Zeleni Dijamant").renderer;
				aktivnaIkonicaMisija3.enabled = true;
