...
public class MainMenuManageFull : MonoBehaviour
{
    ...
    void Awake()
    {
        GameObject.Find("HolderGornjiDesniUgaoDugmici").GetComponent<Transform>().position = new Vector3(
            Camera.main.ViewportToWorldPoint(Vector3.one).x, Camera.main.ViewportToWorldPoint(Vector3.one).y, -0.05f);
        GameObject.Find("HolderGornjiLeviUgaoDugmici").GetComponent<Transform>().position = new Vector3(
            Camera.main.ViewportToWorldPoint(Vector3.zero).x, Camera.main.ViewportToWorldPoint(Vector3.one).y, -0.05f);
        GameObject.Find("HolderDonjiDesniUgaoDugmici").GetComponent<Transform>().position = new Vector3(
            Camera.main.ViewportToWorldPoint(Vector3.one).x, Camera.main.ViewportToWorldPoint(Vector3.zero).y, -0.05f);
        GameObject.Find("HolderDonjiLeviUgaoDugmici").GetComponent<Transform>().position = new Vector3(
            Camera.main.ViewportToWorldPoint(Vector3.zero).x, Camera.main.ViewportToWorldPoint(Vector3.zero).y, -0.05f);
...
//		nivoManager = GameObject.Find("NivoManager").GetComponent<NivoManager>();
    ...
    void Start()
    {
        ...
        {
            case 1:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag1Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[0];
                break;
            case 2:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag2Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[1];
                break;
            case 3:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag3Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[2];
                break;
            case 4:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag4Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[3];
                break;
            case 5:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag5Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[4];
                break;
            case 6:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag6Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[5];
                break;
            case 7:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag7Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[6];
                break;
            case 8:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag8Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[7];
                break;
            case 9:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag9Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[8];
                break;
            case 10:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag10Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[9];
                break;
            case 11:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag11Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[10];
                break;
            case 12:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag12Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[11];
                break;
            case 13:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag13Referenca").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[12];
                break;
            case 14:
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag14Referenca").GetComponent<SpriteRenderer>().sprite;
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0))
        {
            ...
            else if (RaycastFunction(Input.mousePosition) == "MainLanguageSlideLevo")
            {
                ...
                if (Zastave.transform.position.x <=
                    (GameObject.Find("MainLanguageSlideLevo").transform.position.x - 9f))
                {
                }
                else
                {
            ...
            else if (RaycastFunction(Input.mousePosition) == "MainLanguageSlideDesno")
            {
                ...
                if (Zastave.transform.position.x >=
                    (GameObject.Find("MainLanguageSlideDesno").transform.position.x - 3.5f))
                {
                }
                else
                {
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag1")
            {
                Debug.Log("Flag1");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag1").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[0];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag2")
            {
                Debug.Log("Flag2");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag2").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[1];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag3")
            {
                Debug.Log("Flag3");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag3").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[2];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag4")
            {
                Debug.Log("Flag4");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag4").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[3];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag5")
            {
                Debug.Log("Flag5");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag5").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[4];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag6")
            {
                Debug.Log("Flag6");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag6").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[5];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag7")
            {
                Debug.Log("Flag7");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag7").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[6];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag8")
            {
                Debug.Log("Flag8");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag8").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[7];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag9")
            {
                Debug.Log("Flag9");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag9").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[8];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag10")
            {
                Debug.Log("Flag10");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag10").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[9];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag11")
            {
                Debug.Log("Flag11");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag11").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[10];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag12")
            {
                Debug.Log("Flag12");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag12").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[11];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag13")
            {
                Debug.Log("Flag13");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag13").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[12];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
            ...
            else if (RaycastFunction(Input.mousePosition) == "Flag14")
            {
                Debug.Log("Flag14");
                TrenutnaZastava.GetComponent<SpriteRenderer>().sprite =
                    GameObject.Find("Flag14").GetComponent<SpriteRenderer>().sprite;
                TextJezik.GetComponent<TextMesh>().text = JezikTekst[13];
                Zastave.SetActive(false);
                LanguagesAktivan = false;
                Languages.GetComponent<Animation>()["MainLanguageFlagsShow"].normalizedTime = 1;
