...
//						{
//							anim.Play("Blong");
//							playerController.GetComponent<Rigidbody2D>().AddForce(new Vector2(1600,4300));
//						}
                    }
                }
                else if (tip == Tip.Bunika)
                {
                    ...
                    //GameObject.Find("Background").GetComponent<Renderer>().material.color = new Color(148,57,57,255);
                    //GameObject.Find("Background").GetComponent<Renderer>().material.color = new Color(0.58f,0.22f,0.22f,1);
                    GameObject.Find("Background").GetComponent<Renderer>().material.color =
                        new Color(0.82f, 0.07f, 0.75f, 1);
                }
            }
    ...
    {
        playerController.transform.position = new Vector3(transform.Find("Goal").position.x,
            transform.Find("Goal").position.y, playerController.transform.position.z);
...
//		Instantiate(GameObject.Find("PrinceGorilla"),playerController.transform.position,Quaternion.identity);
        ...
        while (goal.GetComponent<Animation>().IsPlaying("MonkeyBounceFromMushroom"))
        {
            ...
            playerController.transform.position =
                new Vector3(goal.position.x, goal.position.y, playerController.transform.position.z);
        }
...
//			playerController.GetComponent<Rigidbody2D>().velocity = Vector2.zero;
//			//playerController.GetComponent<Rigidbody2D>().AddForce(new Vector2(1600,4300));
//			playerController.GetComponent<Rigidbody2D>().velocity = new Vector2(0,60);
//		}
//		else
//		{
//			Debug.Log("inAir je false, VECA SILA");
//			playerController.GetComponent<Rigidbody2D>().velocity = Vector2.zero;
//			playerController.GetComponent<Rigidbody2D>().velocity = new Vector2(0,30);
//			//playerController.GetComponent<Rigidbody2D>().AddForce(new Vector2(1700,4400));
