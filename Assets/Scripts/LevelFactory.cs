...
public class LevelFactory : MonoBehaviour
{
    ...
    int leteciBabuni_postoji_u_poolu =
        0; // 0 - default, 1 - postoji u pool-u i slobodan je, 2 - ne postoji u pool-u ili postoji ali je zauzet, treba da se instancira
...
//		}
    ...
    void Start()
    {
        ...
        unistitelj.position =
            new Vector3(Camera.main.transform.position.x - Camera.main.orthographicSize * Camera.main.aspect,
                unistitelj.position.y, unistitelj.position.z);
...
//		}
    ...
    public IEnumerator RepositionAndFillStuffCoroutine()
    {
        ...
        for (int i = 0; i < terrainPool.childCount; i++)
        {
            ...
            {
                if ((System.Array.IndexOf(TereniKojiMoguDaDodju, prefabProperties.tipTerena) > -1 &&
                     prefabProperties.minimumLevel <= level && prefabProperties.maximumLevel >= level) ||
                    (TereniKojiMoguDaDodju.Length == 0 && prefabProperties.tipTerena != -10))
                {
                    ...
                    if (coinsPool.childCount > 0)
                    {
                        ...
                        for (int i = 0; i < coinsPool.childCount; i++)
                        {
                            ...
                            if (entityProperties.slobodanEntitet)
                            {
                                ...
                                {
                                    if ((System.Array.IndexOf(slotProperties.availableEntities, entityProperties.Type) >
                                         -1) || slotProperties.availableEntities.Length == 0)
                                    {
                        ...
                        if (suzenaListaObjekata.Count > 0)
                        {
                            ...
                            Transform coins =
                                coinsPool.GetChild(suzenaListaObjekata[qq]); //Transform child out of bounds izbacilo
                            ...
                            if (coins != null)
                            {
                                ...
                                {
                                    if (entityProperties.brojPojavljivanja < entityProperties.maxBrojPojavljivanja ||
                                        entityProperties.maxBrojPojavljivanja == 0)
                                    {
                                        ...
                                        coins.position = new Vector3(prefabPropertiess.coinsSlots[j].position.x,
                                            prefabPropertiess.coinsSlots[j].position.y, z);
                        ...
                        if (suzenaListaObjekata.Count > 0)
                        {
                            ...
                            if (environment != null)
                            {
                                ...
                                if (EntityVerovatnoca >= (100 - entityProperties.Verovatnoca))
                                {
                                    ...
                                    {
                                        float scalefactor = Random.Range(entityProperties.originalScale.x,
                                            2 * entityProperties.originalScale.x);
                                    ...
                                    environment.position =
                                        new Vector3(prefabPropertiess.environmentsSlots[j].position.x,
                                            prefabPropertiess.environmentsSlots[j].position.y, z);
    ...
    IEnumerator DodavanjeNeprijatelja(LevelPrefabProperties prefabPropertiess)
    {
        ...
        if (prefabPropertiess.enemies_Slots_Count > 0)
        {
            ...
            for (int j = 0; j < prefabPropertiess.enemiesSlots.Count; j++)
            {
                ...
                if (slotProperties.Verovatnoca >= (100 - trenutnaVerovatnoca))
                {
                    ...
                    if (enemyPool.childCount > 0)
                    {
                        ...
                        for (int i = 0; i < enemyPool.childCount; i++)
                        {
                            ...
                            if ((entityProperties.Type == 3 && leteciBabuni == 1) ||
                                (entityProperties.Type == 7 && boomerangBabuni == 1) ||
                                (entityProperties.Type == 10 && leteceGorile == 1) ||
                                (entityProperties.Type == 14 && kopljeGorile == 1))
                            {
                                //don't summon
                            ...
                            else
                            {
                                ...
                                if (brojacPrefaba == (int) leteciBabuni_Kvota && brojacPrefaba <= 7 &&
                                    leteciBabuni == 0) //obezbediti da se leteci babun obavezno pojavi na slotu
                                {
                                    //Debug.Log("OPAAAAAA 1");
                                    if (entityProperties.Type == 3)
                                    {
                                        //Debug.Log("OPAAAAAA 2");
                                        if ((System.Array.IndexOf(slotProperties.availableEntities,
                                                entityProperties.Type) > -1) ||
                                            slotProperties.availableEntities.Length == 0)
                                        {
                                            ...
                                            if (entityProperties.slobodanEntitet)
                                            {
                                                ...
                                                entityProperties.slobodanEntitet = false;
                                                entityProperties.trenutnoJeAktivan = false;
                                                if (entityProperties.Type != 15 || entityProperties.Type != 16 ||
                                                    entityProperties.Type != 17 || entityProperties.Type != 18)
                                                {
                                                    for (int ii = 0; ii < enemy.childCount; ii++)
                                                        enemy.GetChild(ii).Find("BaboonReal").Find("_MajmunceNadrlja")
                                                            .GetComponent<BabunDogadjaji_new>().ResetujBabuna();
                                                }

                                                enemy.position =
                                                    new Vector3(prefabPropertiess.enemiesSlots[j].position.x,
                                                        prefabPropertiess.enemiesSlots[j].position.y, z);
                                ...
                                if (brojacPrefaba == (int) leteceGorile_Kvota && brojacPrefaba <= 7 &&
                                    leteceGorile == 0) //obezbediti da se leteci gorila obavezno pojavi na slotu
                                {
                                ...
                                if (brojacPrefaba == (int) boomerangBabuni_Kvota && brojacPrefaba <= 7 &&
                                    boomerangBabuni == 0) //obezbediti da se boomerang babun obavezno pojavi na slotu
                                {
                                ...
                                if (brojacPrefaba == (int) kopljeGorile_Kvota && brojacPrefaba <= 7 &&
                                    kopljeGorile == 0) //obezbediti da se koplje gorila obavezno pojavi na slotu
                                {
                        ...
                        if (leteciBabuni_postoji_u_poolu == 2)
                        {
                            ...
                            if (brojacPrefaba == (int) leteciBabuni_Kvota && brojacPrefaba <= 7 && leteciBabuni == 0)
                            {
                                ...
                                if (slotJeSlobodan)
                                {
                                    ...
                                    KorigujVerovatnocuZbogMisije(2, 1);
                                    leteciBabuni_Kvota += leteciBabuni_Kvota_locked;
                                    GameObject a = Instantiate(enemiesForInstantiate[2],
                                        new Vector3(prefabPropertiess.enemiesSlots[j].position.x,
                                            prefabPropertiess.enemiesSlots[j].position.y,
                                            prefabPropertiess.enemiesSlots[j].position.z),
                                        Quaternion.identity) as GameObject;
                                    for (int ii = 0; ii < a.transform.childCount; ii++)
                                        a.transform.GetChild(ii).Find("BaboonReal").Find("_MajmunceNadrlja")
                                            .GetComponent<BabunDogadjaji_new>().ResetujBabuna();
                        ...
                        if (leteceGorile_postoji_u_poolu == 2)
                        {
                            ...
                            if (brojacPrefaba == (int) leteceGorile_Kvota && brojacPrefaba <= 7 && leteceGorile == 0)
                            {
                                ...
                                if (slotJeSlobodan)
                                {
                                    ...
                                    KorigujVerovatnocuZbogMisije(2, 2);
                                    leteceGorile_Kvota += leteceGorile_Kvota_locked;
                                    GameObject a = Instantiate(enemiesForInstantiate[9],
                                        new Vector3(prefabPropertiess.enemiesSlots[j].position.x,
                                            prefabPropertiess.enemiesSlots[j].position.y,
                                            prefabPropertiess.enemiesSlots[j].position.z),
                                        Quaternion.identity) as GameObject;
                        ...
                        if (boomerangBabuni_postoji_u_poolu == 2)
                        {
                                ...
                                boomerangBabuni == 0)
                            {
                                ...
                                if (slotJeSlobodan)
                                {
                                    ...
                                    KorigujVerovatnocuZbogMisije(2, 3);
                                    boomerangBabuni_Kvota += boomerangBabuni_Kvota_locked;
                                    GameObject a = Instantiate(enemiesForInstantiate[6],
                                        new Vector3(prefabPropertiess.enemiesSlots[j].position.x,
                                            prefabPropertiess.enemiesSlots[j].position.y,
                                            prefabPropertiess.enemiesSlots[j].position.z),
                                        Quaternion.identity) as GameObject;
                        ...
                        if (kopljeGorile_postoji_u_poolu == 2)
                        {
                            ...
                            if (brojacPrefaba == (int) kopljeGorile_Kvota && brojacPrefaba <= 7 && kopljeGorile == 0)
                            {
                                ...
                                if (slotJeSlobodan)
                                {
                                    ...
                                    KorigujVerovatnocuZbogMisije(2, 4);
                                    kopljeGorile_Kvota += kopljeGorile_Kvota_locked;
                                    GameObject a = Instantiate(enemiesForInstantiate[13],
                                        new Vector3(prefabPropertiess.enemiesSlots[j].position.x,
                                            prefabPropertiess.enemiesSlots[j].position.y,
                                            prefabPropertiess.enemiesSlots[j].position.z),
                                        Quaternion.identity) as GameObject;
                        ...
                        if (suzenaListaObjekata.Count > 0 && slotJeSlobodan)
                        {
                                ...
                                if (EntityVerovatnoca >= (100 - entityProperties.Verovatnoca))
                                {
                                        ...
                                        entityProperties.Type != 17 && entityProperties.Type != 18)
                                    {
                                        for (int i = 0; i < enemy.childCount; i++)
                                        {
                                            ...
                                            enemy.GetChild(i).Find("BaboonReal").Find("_MajmunceNadrlja")
                                                .GetComponent<BabunDogadjaji_new>().ResetujBabuna();
                                        }
                                    }
                                    ...
                                    entityProperties.slobodanEntitet = false;
                                    entityProperties.trenutnoJeAktivan = false;
                                    enemy.position = new Vector3(prefabPropertiess.enemiesSlots[j].position.x,
                                        prefabPropertiess.enemiesSlots[j].position.y, z);
                            ...
                            (suzenaListaObjekata.Count == 0 &&
                             slotJeSlobodan) //slot se koristi, ali nema dovoljno neprijatelja u enemyPool-u, svi koji postoje se vec koriste, treba da se instancira neprijatelj
                        {
                            int qq = Random.Range(0, slotProperties.availableEntities.Length);
                            int enemyType = slotProperties.availableEntities[qq];
                            GameObject a = Instantiate(enemiesForInstantiate[enemyType - 1],
                                new Vector3(prefabPropertiess.enemiesSlots[j].position.x,
                                    prefabPropertiess.enemiesSlots[j].position.y,
                                    prefabPropertiess.enemiesSlots[j].position.z), Quaternion.identity) as GameObject;
                            entityProperties = a.GetComponent<EntityProperties>();
                            a.transform.parent = enemyPool;
                            entityProperties.instanciran = true;
                            entityProperties.slobodanEntitet = false;
                    ...
                    if (leteciBabuni == 0)
                    {
                        if (enemyPool.childCount > 0)
                        {
                            ...
                            for (int i = 0; i < enemyPool.childCount; i++)
                            {
                                ...
                                //Debug.Log("properti da moze: " + entityProperties.Type + ", brojac: " + brojacPrefaba + ", leteciBabuniKvota: " + ((int)leteciBabuni_Kvota) + ", korigovancija: " + leteciBabuni);
                                if (brojacPrefaba == (int) leteciBabuni_Kvota &&
                                    brojacPrefaba <= 7) //obezbediti da se leteci babun obavezno pojavi na slotu
                                {
                    ...
                    if (leteceGorile == 0)
                    {
                        if (enemyPool.childCount > 0)
                        {
                            ...
                            for (int i = 0; i < enemyPool.childCount; i++)
                            {
                                ...
                                //Debug.Log("properti da moze: " + entityProperties.Type + ", brojac: " + brojacPrefaba + ", leteceGorileKvota: " + ((int)leteceGorile_Kvota) + ", korigovancija: " + leteceGorile);
                                if (brojacPrefaba == (int) leteceGorile_Kvota &&
                                    brojacPrefaba <= 7) //obezbediti da se leteci gorila obavezno pojavi na slotu
                                {
                    ...
                    if (boomerangBabuni == 0)
                    {
                        if (enemyPool.childCount > 0)
                        {
                            ...
                            for (int i = 0; i < enemyPool.childCount; i++)
                            {
                                ...
                                //Debug.Log("properti da moze: " + entityProperties.Type + ", brojac: " + brojacPrefaba + ", boomerangBabuniKvota: " + ((int)boomerangBabuni_Kvota) + ", korigovancija: " + boomerangBabuni);
                                if (brojacPrefaba == (int) boomerangBabuni_Kvota &&
                                    brojacPrefaba <= 7) //obezbediti da se boomerang babun obavezno pojavi na slotu
                                {
                    ...
                    if (kopljeGorile == 0)
                    {
                        if (enemyPool.childCount > 0)
                        {
                            ...
                            for (int i = 0; i < enemyPool.childCount; i++)
                            {
                                ...
                                //Debug.Log("properti da moze: " + entityProperties.Type + ", brojac: " + brojacPrefaba + ", kopljeGorileKvota: " + ((int)kopljeGorile_Kvota) + ", korigovancija: " + kopljeGorile);
                                if (brojacPrefaba == (int) kopljeGorile_Kvota &&
                                    brojacPrefaba <= 7) //obezbediti da se koplje gorila obavezno pojavi na slotu
                                {
                ...
                if (j == prefabPropertiess.enemiesSlots.Count -
                    1) //prosao kroz sve prefabove i sticajem okolnosti nije postavio neprijatelja, treba da poveca brojac da bi bilo regularno za naredne prefabove
                {
                    //Debug.Log("ZADNJI SLOT U PREFABU");
                    if (postavljen_u_prefabu_leteciBabuni == 2 && brojacPrefaba == (int) leteciBabuni_Kvota &&
                        brojacPrefaba <= 7)
                    {
                    ...
                    if (postavljen_u_prefabu_leteceGorile == 2 && brojacPrefaba == (int) leteceGorile_Kvota &&
                        brojacPrefaba <= 7)
                    {
                    ...
                    if (postavljen_u_prefabu_boomerangBabuni == 2 && brojacPrefaba == (int) boomerangBabuni_Kvota &&
                        brojacPrefaba <= 7)
                    {
                    ...
                    if (postavljen_u_prefabu_kopljeGorile == 2 && brojacPrefaba == (int) kopljeGorile_Kvota &&
                        brojacPrefaba <= 7)
                    {
                ...
                if (slotProperties.Verovatnoca >= (100 - trenutnaVerovatnoca))
                {
                    ...
                    if (specialPool.childCount > 0)
                    {
                        ...
                        for (int i = 0; i < specialPool.childCount; i++)
                        {
                            ...
                            if ((entityProperties.Type == 5 && crveniDijamant == 1) ||
                                (entityProperties.Type == 6 && plaviDijamant == 1) ||
                                (entityProperties.Type == 7 && zeleniDijamant == 1))
                            {
                                //don't summon
                            }
                            else
                            {
                                ...
                                if (brojacPrefaba == (int) plaviDijamant_Kvota && brojacPrefaba <= 7 &&
                                    plaviDijamant ==
                                    0) //obezbediti da se plavi dijamant obavezno pojavi na jednom slotu u okviru trenutnog terena
                                {
                                    if (entityProperties.Type == 6 &&
                                        slotJeSlobodan) //special entitet jeste plavi dijamant ( iznad umesto !=1 bilo je ==0)
                                    {
                                        if ((System.Array.IndexOf(slotProperties.availableEntities,
                                                entityProperties.Type) > -1) ||
                                            slotProperties.availableEntities.Length == 0)
                                        {
                                            ...
                                            if (entityProperties.slobodanEntitet) //plavi dijamant je slobodan
                                            {
                                                ...
                                                entityProperties.trenutnoJeAktivan = false;
                                                special.position =
                                                    new Vector3(prefabPropertiess.specialSlots[j].position.x,
                                                        prefabPropertiess.specialSlots[j].position.y, z);
                                ...
                                if (brojacPrefaba == (int) crveniDijamant_Kvota && brojacPrefaba <= 7 &&
                                    crveniDijamant ==
                                    0) //obezbediti da se crveni dijamant obavezno pojavi na jednom slotu u okviru trenutnog terena
                                {
                                    if (entityProperties.Type == 5 &&
                                        slotJeSlobodan) //special entitet jeste crveni dijamant
                                    {
                                ...
                                if (brojacPrefaba == (int) zeleniDijamant_Kvota && brojacPrefaba <= 7 &&
                                    zeleniDijamant ==
                                    0) //obezbediti da se zeleni dijamant obavezno pojavi na jednom slotu u okviru trenutnog terena
                                {
                                    if (entityProperties.Type == 7 &&
                                        slotJeSlobodan) //special entitet jeste zeleni dijamant
                                    {
                                        //if((System.Array.IndexOf(slotProperties.availableEntities, entityProperties.Type) > -1) || slotProperties.availableEntities.Length == 0)
                                        {
...
//												}
//												else
                                            if ((entityProperties.name.Contains("Magnet") && magnetCollected) ||
                                                (entityProperties.name.Contains("Magnet") && brojacPrefaba < 2))
                                            {
                                                //magnet collected, don't add
                                            }
                                            else if ((entityProperties.name.Contains("DoubleCoins") &&
                                                      doubleCoinsCollected) ||
                                                     (entityProperties.name.Contains("DoubleCoins") &&
                                                      brojacPrefaba < 2))
                                            {
                                                //double coins collected, don't add
                                            }
                                            else if ((entityProperties.name.Contains("Shield") && shieldCollected) ||
                                                     (entityProperties.name.Contains("Shield") && brojacPrefaba < 2))
                                            {
                        ...
                        if (plaviDijamant_postoji_u_poolu == 2)
                        {
                            ...
                            if (brojacPrefaba == (int) plaviDijamant_Kvota && brojacPrefaba <= 7 && plaviDijamant == 0)
                            {
                                ...
                                if (slotJeSlobodan)
                                {
                                    ...
                                    KorigujVerovatnocuZbogMisije(2, 5);
                                    plaviDijamant_Kvota += plaviDijamant_Kvota_locked;
                                    GameObject a = Instantiate(specialsForInstantiate[1],
                                        new Vector3(prefabPropertiess.specialSlots[j].position.x,
                                            prefabPropertiess.specialSlots[j].position.y,
                                            prefabPropertiess.specialSlots[j].position.z),
                                        Quaternion.identity) as GameObject;
                                    //a.transform.localScale = a.transform.localScale*15;
                                    slotJeSlobodan = false;
                        ...
                        if (crveniDijamant_postoji_u_poolu == 2)
                        {
                                ...
                                crveniDijamant == 0)
                            {
                                if (slotJeSlobodan)
                                {
                                    ...
                                    KorigujVerovatnocuZbogMisije(2, 6);
                                    crveniDijamant_Kvota += crveniDijamant_Kvota_locked;
                                    GameObject a = Instantiate(specialsForInstantiate[0],
                                        new Vector3(prefabPropertiess.specialSlots[j].position.x,
                                            prefabPropertiess.specialSlots[j].position.y,
                                            prefabPropertiess.specialSlots[j].position.z),
                                        Quaternion.identity) as GameObject;
                        ...
                        if (zeleniDijamant_postoji_u_poolu == 2)
                        {
                                ...
                                zeleniDijamant == 0)
                            {
                                ...
                                if (slotJeSlobodan)
                                {
                                    ...
                                    KorigujVerovatnocuZbogMisije(2, 7);
                                    zeleniDijamant_Kvota += zeleniDijamant_Kvota_locked;
                                    GameObject a = Instantiate(specialsForInstantiate[2],
                                        new Vector3(prefabPropertiess.specialSlots[j].position.x,
                                            prefabPropertiess.specialSlots[j].position.y,
                                            prefabPropertiess.specialSlots[j].position.z),
                                        Quaternion.identity) as GameObject;
                            ...
                            if (special != null)
                            {
                                ...
                                if (EntityVerovatnoca >= (100 - entityProperties.Verovatnoca))
                                {
                                        ...
                                        entityProperties.maxBrojPojavljivanja == 0)
                                    {
                                        ...
                                        entityProperties.slobodanEntitet = false;
                                        entityProperties.trenutnoJeAktivan = false;
                                        special.position = new Vector3(prefabPropertiess.specialSlots[j].position.x,
                                            prefabPropertiess.specialSlots[j].position.y, z);
...
//				KorigujVerovatnocuZbogMisije(0,7);
    ...
    void Tezina()
    {
        ...
        if (tour == 1)
        {
            switch (levell)
            {
                ...
                case 3:
                case 4:
                    overallDifficulty = world;
                    break;
                case 5:
                case 6:
                case 7:
                case 8:
                    overallDifficulty = world + 1;
                    break;
                case 9:
                case 10:
                case 11:
                case 12:
                    overallDifficulty = world + 2;
                    break;
                case 13:
                case 14:
                case 15:
                case 16:
                    overallDifficulty = world + 3;
                    break;
                case 17:
                case 18:
                case 19:
                case 20:
                    overallDifficulty = world + 4;
                    break;
            }
        }
        else if (tour == 2)
        {
            switch (levell)
            {
                ...
                case 15:
                case 16:
                    overallDifficulty = world + 5;
                    break;
                case 17:
                case 18:
                case 19:
                case 20:
                    overallDifficulty = world + 6;
                    break;
            }
        }
        else if (tour == 3)
        {
            switch (levell)
            {
                ...
                case 15:
                case 16:
                    overallDifficulty = world + 7;
                    break;
                case 17:
                case 18:
                case 19:
                case 20:
                    overallDifficulty = world + 8;
                    break;
            }
        }
    ...
    public void
        KorigujVerovatnocuZbogMisije(int value,
            int tip) //value: 0 - regularno se pojavljuje, 1 - 0% verovatnoca, 2 - 100% verovatnoca, ali da se samo jedanput postavi u okviru jednog slota 
    {
