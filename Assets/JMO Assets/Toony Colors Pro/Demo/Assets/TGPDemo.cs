...
public class TGPDemo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (scrollWheel != 0)
        {
            ...
            Camera.main.transform.position =
                new Vector3(Camera.main.transform.position.x, Camera.main.transform.position.y, zoom);
        }
    ...
    private void UpdateGUITButtons()
    {
        ...
        foreach (GUIT_Button btn in buttons)
        {
            ...
            {
                case "SwitchOutline":
                    btn.UpdateState(outline);
                    break;
                case "SwitchRim":
                    btn.UpdateState(rim);
                    break;
                case "SwitchRimOutline":
                    btn.UpdateState(rimOutline);
                    break;
                default: break;
            }
        }
    ...
    void UpdateRamp()
    {
        rampUI.material.mainTexture = rampTextures[rampIndex];
